...
if(isset($_POST["ingreso"]))
{
	...
	{
		$coneccion=mysql_connect("localhost", "root", "ucentral2007") or die(mysql_error());
		mysql_select_db("larruy", $coneccion) or die(mysql_error());
...
if(isset($_POST["busqueda"]))
{
	...
	if(validaBusqueda($valor))
	{
		...
		$consulta=mysql_query("SELECT placa FROM vehiculos WHERE placa LIKE '".$valor."%' AND dueno='no' LIMIT 0, 22");
