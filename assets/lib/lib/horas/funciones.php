...
function crearHora($usuario, $hora, $idCiudad, $paciente, $prestador, $isapre, $confirmada, $observacion,$numerolicencia, $conectar)
{
	...
	INSERT INTO 
		horas 
		(usuario, hora, fecha, ciudad, paciente, prestador, isapre, confirmada, observacion,numerolicencia)
	VALUES
		($usuario, '$hora', '$fechaActual', '$idCiudad',  $paciente, $prestador, $isapre, '$confirmada','$observacion','$numerolicencia')
	", $conectar);
	$sql ="
	INSERT INTO
		horas
...
function crearHoralista($usuario, $hora, $idCiudad, $paciente, $prestador, $isapre, $confirmada, $observacion, $conectar)
{
    setlocale(LC_ALL,"SP");
    $fechaActual = strftime("%d")." de ".strftime("%B")." de ".strftime("%Y");
    $fechaActual = editames($fechaActual);
