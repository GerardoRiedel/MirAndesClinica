...
function numeroPeritajesSolicitadosPorIsapreMes($isapre, $mes, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		h.`id` 
...
//ASISTENCIA
//
function asistenciaAno($ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		h.`id` 
...
function inasistenciaAno($ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		h.`id` 
...
function asistenciaPorIsapreAno($isapre, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		h.`id` 
...
function inasistenciaPorIsapreAno($isapre, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		h.`id` 
...
function asistenciaPorIsapreCiudadAno($isapre, $ciudad, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		h.`id` 
...
function inasistenciaPorIsapreCiudadAno($isapre, $ciudad, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		h.`id` 
...
function pacientesMujeresIsapreAno($isapre, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		i.`hora`
	...
	WHERE 
		...
		i.`sexo`='F' AND 
		h.`isapre`=".$isapre." AND
		DATE(h.`hora`) BETWEEN '".$ano."-01-01' AND '".$ano."-12-31'
	GROUP BY 
		i.`hora`
	", $conectar);
...
function pacientesHombresIsapreAno($isapre, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		i.`hora`
...
//
function pacientesOcupacionIsapreAno($ocupacion, $isapre, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		i.`hora`
...
//OPINIÓN DE LA LM
//
function pacientesOpinionLMIsapreAno($opinion, $isapre, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		i.`hora`
...
//OPINIÓN TRATAMIENTO
//
function pacientesOpinionTratamientoIsapreAno($opinion, $isapre, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		i.`hora`
...
function numeroPeritajesSolicitadosPorIsapreCiudad($isapre, $ciudad, $ano, $conectar)
{
	$sql = mysql_query("
	SELECT 
		h.`id` 
