...
class Impresiones extends CI_Controller {
    ...
    public function cargarImprimir($id)
    {
        ...
        Layout_Helper::cargaVista($this,'imprimirTodo',$data,'clinica');   
...
///TENGO QUE BUSCAR EL ULTIMO DEPOSITO       
        ...
        $opciones[15]= $this->input->post('formSuicida');
        $opciones[16]= $this->input->post('formDowton');
        ...
        $data['regimen']    = $this->pacientes_model->dameRegimen();
        Layout_Helper::cargaVista($this,'imprimirImprimir',$data,'clinica');   
...
///TENGO QUE BUSCAR EL ULTIMO DEPOSITO       
    ...
    public function imprimirHojaEnfermeria($id)
    {
        ...
        Layout_Helper::cargaVista($this,'imprimirHojaEnfermeria',$data,'clinica');   
    }
    /*
    public function imprimirRendicion($renId)
    {
        ...
        Layout_Helper::cargaVista($this,'imprimirRendicion',$data,'clinica');   
    }
     * *
     */
}
