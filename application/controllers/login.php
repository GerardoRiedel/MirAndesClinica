	...
	public function index()
	{
                    ...
                    //CLINICA        
                        if($this->session->userdata('perfil') == '1'){
                            IF($nav != 'Chrome'){
                            echo "<script>".$alert."window.location.href='".base_url()."clinica_admision/charts/chartsTodo';</script>";}
                            ELSE {redirect(base_url().'clinica_admision/charts/chartsTodo');}
		...
		if($this->input->post('token') && $this->input->post('token') == $this->session->userdata('token'))
		{
			...
			{   
				...
				if($check_user == TRUE)
				{
                                                                                ...
                                                                                IF($check_user->uspPerfil=='1' || $check_user->uspPerfil=='2') {
