...
Cetep';
        ...
        redirect(base_url().'clinica_admision/tecs/listarIngreso/');
        }
        ELSE Layout_Helper::cargaVista($this,'deposito_tec',$data,'ingresos');   
...
////GUARDAR CONTACTO     
        ...
        $data['submenu']    = "ltecs";
        $ges = $this->input->post('ges');
        IF($ges === '1')redirect(base_url().'clinica_admision/tecs/listarIngreso/');
        ELSE Layout_Helper::cargaVista($this,'imprimirTec',$data,'ingresos');   
    ...
    public function nuevaSession($tecId)
    {
        ...
        $data['menu']       = "tecs";
        $data['submenu']    = "ltecs";
        Layout_Helper::cargaVista($this,'nueva_session',$data,'ingresos');  
    }
    ...
    public function guardarInsumos()
    {
        ...
        IF(!empty($cantidad) && $exam[0]!=='0'){
           ...
           $id = $tecId.'_'.$id;  
        redirect(base_url().'clinica_admision/tecs/cargarInsumos/'.$id);
    ...
    public function eliminarInsumo($id)
    {
        ...
        $this->tecs_model->guardarInsumosAsignados();
        redirect(base_url().'clinica_admision/tecs/cargarInsumos/'.$id[0].'_'.$id[1]);
    }
    ...
    public function listarDepositosTEC()
    {
        ...
        $data['insumos']    = $this->tecs_model->dameCostosInsumos();
        $data['honorariosLE'] = 108000;
        $data['honorariosGES'] = 38000;
        //die(var_dump($data['insumos']));
        //die(var_dump($data['GESH']));
        $data['breadcumb']  = "Registros";
        $data['title']      = "T.E.C - Listar Depositos";
        $data['menu']       = "tecs";
        $data['submenu']    = "dtecs";
        Layout_Helper::cargaVista($this,'listar_depositos',$data,'ingresos');  
    }
