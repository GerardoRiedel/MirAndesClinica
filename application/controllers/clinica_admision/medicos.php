...
class Medicos extends CI_Controller {
    ...
    public function cargarNuevoControl($idPaciente)
    {
        ...
        Layout_Helper::cargaVista($this,'cargarNuevoControl',$data,'ingresos');   
    }
    ...
    public function listarControles($registro)
    {
       ...
       IF(!empty($controlesUGH))$controles = array_merge($controles,$controlesUGH);
        ...
        $data['menu']       = "ficha";
        $data['submenu']    = "ficha";
        Layout_Helper::cargaVista($this,'listarControles',$data,'ingresos');   
    }
    ...
    public function listarEvaluacion($registro)
    {
       ...
       //F(!empty($controlesUGH))$controles = array_merge($controles,$controlesUGH);
        ...
        $data['menu']       = "ficha";
        $data['submenu']    = "ficha";
        Layout_Helper::cargaVista($this,'listarEvaluacion',$data,'ingresos');   
    }
    public function listarControlesUGH($registro)
    {
        ...
        $data['menu']       = "ficha";
        $data['submenu']    = "ficha";
        Layout_Helper::cargaVista($this,'listarControlesUGH',$data,'ingresos');   
    }
}