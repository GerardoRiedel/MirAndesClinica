...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
            ...
            //die(var_dump($datos));
                echo form_open('hd_admision/modificar/guardarModificarUsuario',$attributes);
            ?>
...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
            ...
            <!-- DATOS DE PERSONALES-->               
                    ...
                    <div class="col-lg-12" style=" margin-top: 30px" align="center">
                        <button style="width:10%" onclick="goBack()" class="btn btn-default btn-sm btnVolver">Cancelar</button><script>function goBack(){window.history.go(-1);}</script>
                    ...
                    <div class='col-lg-4' >
                        ...
                        <select name="uspPerfil" id="uspPerfil">
                            ...
                            <option value="11" <?php IF($perfil === '11')echo 'selected'; ?>>Administrador</option>
                            <option value="12" <?php IF($perfil === '12')echo 'selected'; ?>>Admisión</option>
                            <!--
                            <option value="13" <?php IF($perfil === '13')echo 'selected'; ?>>Paramedico</option>
                            -->
                            <option value="14" <?php IF($perfil === '14')echo 'selected'; ?>>Enfermeria</option>
