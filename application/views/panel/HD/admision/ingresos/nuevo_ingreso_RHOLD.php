...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                    ...
                    <div class='col-lg-4'>
                        <input name="ficha"  type="text" minlength="4" id="ficha" placeholder="Solo paciente antiguo" value="<?php IF(!empty($datos->ficha))echo $datos->ficha;?>">
                    </div> 
                    ...
                    <div class='col-lg-3' >
                        <table>
                            <tbody>
                            <tr>
                                <td style=" width: 30px" align="center"><div id="hdia"><input type="radio" name="tipoIngreso" value="2" id="hdia" <?php IF(!empty($datos->tipoIngreso)){IF($datos->tipoIngreso === '2')echo 'checked';};?>></div></td>
                                <td style=" width: 110px">Hospital de día</td>
                                <td style=" width: 30px" align="center"><div id="reha"><input type="radio" name="tipoIngreso" value="3" id="reha" <?php IF(!empty($datos->tipoIngreso)){IF($datos->tipoIngreso === '3')echo 'checked';}ELSE {echo 'checked';};?>></div></td>
                ...
                <!--DATOS CLINICOS-->
                    ...
                    <div class='col-lg-4'>
                        <input name="emergenciaDerivar" type="text" required id="emergenciaDerivar" required value="<?php IF(!empty($datos->emergenciaDerivar))echo strtoupper($datos->emergenciaDerivar);?>">
                    </div>   
                    <div class="col-lg-2">
                        <label>Alergia: </label>
                    </div>
...
<!--DERIVACION-->
                ...
                <!-- DATOS DE CONVENIO-->            
                    ...
                    <div class='col-lg-4'>
                        <input name="rutTitular" type="text" required minlength="7" id="rutTitular" value="<?php IF(!empty($datos->rutTitular))echo formatearRut($datos->rutTitular);?>" >
                    </div>
                    <div class="col-lg-2">
                        <label>Nombre Titular</label>
                    </div>
                    <div class='col-lg-4'>
                        <input name="nombreTitular" type="text" required id="nombreTitular" value="<?php IF(!empty($datos->nombreTitular))echo strtoupper($datos->nombreTitular);?>">
                    </div>
                    <div class="col-lg-12" style="margin-top: 10px"></div>
                    <div class="col-lg-2">
                    ...
                    <div class='col-lg-4'>
                        <input name="apePatTitular" type="text" required id="apePatTitular" value="<?php IF(!empty($datos->apePatTitular))echo strtoupper($datos->apePatTitular);?>">
                    </div>
                    <div class="col-lg-2">
                        <label>Apellido Materno Titular</label>
                    </div>
                    <div class='col-lg-4'>
                        <input name="apeMatTitular" type="text" required id="apeMatTitular" value="<?php IF(!empty($datos->apeMatTitular))echo strtoupper($datos->apeMatTitular);?>">
                    </div>
                    <div class="col-lg-12"></div>
    ...
    <div id="divApo">
                    ...
                    <div class='col-lg-4'>
                        <input name="rutApo" type="text" required minlength="7" placeholder="Digite run de apoderado" id="rutApo" value="<?php IF(!empty($datosApo[0]->apoRut))echo formatearRut($datosApo[0]->apoRut);?>"><br><h7 style="font-size:8px">&nbsp;&nbsp;&nbsp;ejemplo 12345678-9</h7>
                    </div> 
                    <div class="col-lg-12" ></div>
    </div>             
<div id="divFichaApoderado"><!--INICIO DIVFICHA APODERADO-->
                    ...
                    <div class='col-lg-4'>
                        <input name="nombresApo"  type="text" minlength="3" required id="nombresApo" value="<?php IF(!empty($datosApo[0]->apoNombre))echo strtoupper($datosApo[0]->apoNombre);?>">
                    </div>
                    <div class="col-lg-2">
                        <label>Apellido Paterno</label>
                    </div>
                    <div class='col-lg-4'>
                        <input name="apePatApo"  type="text" minlength="3" required id="apePatApo" value="<?php IF(!empty($datosApo[0]->apoApePat))echo strtoupper($datosApo[0]->apoApePat);?>">
                    </div> 
                    ...
                    <div class='col-lg-4'>
                        <input name="apeMatApo"  type="text" minlength="3" required id="apeMatApo" value="<?php IF(!empty($datosApo[0]->apoApeMat))echo strtoupper($datosApo[0]->apoApeMat);?>">
                    </div> 
                    <div class="col-lg-12"></div><!--SALTO DE LINEA-->
                    <div class="col-lg-2">
                        <label>Dirección</label>
                    ...
                    <div class='col-lg-4'>
                        <input name="direccionApo"  type="text" minlength="4" required id="direccionApo" value="<?php IF(!empty($datosApo[0]->apoDireccion))echo strtoupper($datosApo[0]->apoDireccion);?>">
                    </div>
                    <div class="col-lg-2">
                        <label>Comuna</label>
                    </div>
                    ...
                    <div class='col-lg-4'>
                        <input name="telMovilApo"  type="text" minlength="9" pattern="[0-9]{9}" required id="telCeluApo" value="<?php IF(!empty($datosApo[0]->apoCelular))echo $datosApo[0]->apoCelular;?>">
                    </div>
                    <div class="col-lg-12"></div><!--SALTO DE LINEA-->
                    <div class="col-lg-2">
                        <label>Email</label>
    ...
    $("#ocupacion").focusout(function(){
        //ENVIAR DATOS GUARDAR
                    ...
                    if(rut!=''){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>" + "api/ingresosRH/guardar/"+array,
                            dataType: 'json',
...
<script>
    ...
    focusout:function(){
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url(); ?>" + "api/ingresosRH/index/"+rut,
            dataType: 'json',
            ...
            success: function(data){
                ...
                if (data.rut != undefined){
                        ...
                        $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>" + "api/ingresosRH/ficha/"+data.rut,
                        dataType: 'json',
