...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25; background-color: #db8918">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            ...
            //die(var_dump($datos));
                echo form_open('hd_admision/ingresos/guardarModificarRegistro',$attributes);
            ?>
            ...
            <div class='widget-content'>
                ...
                <br>
                    ...
                    <div class='col-lg-4'>
                        <input type="text" placeholder="día-mes-año" name="fechaIngreso" value="<?php IF(!empty($datos->fechaIngreso))echo $datos->fechaIngreso;?>" readonly="true" >
                    </div>
