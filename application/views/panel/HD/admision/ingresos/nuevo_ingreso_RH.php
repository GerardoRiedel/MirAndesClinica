...
<div id="divFichaApoderado"><!--INICIO DIVFICHA APODERADO-->
  ...
  <!-- CIERRE APODERADO-->                  
                ...
                <!-- OTRO CONTACTO-->    
                    ...
                    <div class='col-lg-4'>
                        <select name="parentescoOtroContacto"  id="parentescoOtroContacto">
...
<!--DERIVACION-->
                    ...
                    <div class='col-lg-10'>
                        ...
                        <input name="diagnostico" id="diagnostico" style=" width: 84%;" type="text" value="<?php IF(!empty($datos->diagnostico))echo $datos->diagnostico;?>"><h7 style=" font-size: 8px"> (campo no obligatorio)</h7>
                    </div>
                    <div class="col-lg-12"></div>
                    <div class="col-lg-2">
                    ...
                    <div class='col-lg-4'>
                        <div class="input-group input-group-sm date datepicker"  data-date="<?php //echo (new DateTime())->format('Y-m-d H:i:s') ?>" data-date-format="yyyy-mm-dd">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
