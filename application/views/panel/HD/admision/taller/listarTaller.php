...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" ><br>
    <a href="<?php echo base_url("hd_admision/taller/crearTaller/")?>" style="color: #da812e; font-size: 30px; padding-top: -30px;margin-top:-30px;margin-bottom: 5px;margin-left: 25px" title="Crear Taller"><i class="fa fa-plus" aria-hidden="true"></i></a>
                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php $date = new DateTime($item->talFechaRegistro);echo $date->format('d-m-Y'); ?></td>
                                <td><?php echo strtoupper($item->uspNombre).' '.strtoupper($item->uspApellidoP); ?></td>
                                <td><?php echo $item->talDescripcion; ?></td>
                                <td><?php echo $item->talObservacion; ?></td>
                                <td align="center">
                                    <a class="tip-bottom" title="Modificar registro" href="<?php echo base_url("hd_admision/taller/crearTaller/" . $item->talId )?>"><i class="fas fa-edit" aria-hidden="true"></i></a>&nbsp;&nbsp;
                                    <a class="tip-bottom" onclick="return confirm('¿Confirma que desea eliminar este registro?')" style="color:red" title="Eliminar Registro" href="<?php echo base_url("hd_admision/taller/eliminarTaller/" . $item->talId )?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </td>
