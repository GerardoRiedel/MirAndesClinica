                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a class="tip-bottom" title="Agregar Nueva Licencia" href="<?php echo base_url("hd_admision/ingresos/cargarLicencia/" . $item->licRut )?>"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                                <?php endforeach; ?>
                        </tbody>
