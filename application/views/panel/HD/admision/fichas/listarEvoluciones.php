                        ...
                        <table class='table table-bordered table-hover table-striped'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                    <a class="tip-bottom" title="Ver Registro de Evolución" href="<?php echo base_url("hd_admision/fichas/cargarEvolucion/" . $evo->evoId )?>"><i class="fa fa-hand-o-right" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                <?php };?>
                            </tbody>
