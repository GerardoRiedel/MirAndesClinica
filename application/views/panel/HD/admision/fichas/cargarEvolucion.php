...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25; background-color: #db8918">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            ...
            //die(var_dump($datos));
                echo form_open('hd_admision/ingresos/guardarNuevoRegistro',$attributes);
            ?>
...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
            ...
            <!-- DATOS DE CLINICOS-->  
                    ...
                    <div class="col-lg-12" align="center">
                        <?php
                        $this->load->view('panel/MirAndesClinica/clinica_enfermeria/ingresos/tablas/formCSV');
                        ?>
                    ...
                    <div class="col-lg-4">Noche: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="evoSueNoche" id="evoSueNoche" value="<?php echo $evo->evoSueNoche;?>" readonly>
                    </div>
                    <div class="col-lg-12"><br></div>
                    ...
                    <div class="col-lg-4">Noche: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="evoHidraNoche" id="evoHidraNoche" value="<?php echo $evo->evoHidraNoche;?>" readonly>
                    </div>
                    <div class="col-lg-12"><br></div>
                    ...
                    <div class="col-lg-5" style=" margin-left: -64px">
                        <input type="text" name="evoTOOtro" id="evoTOOtro" style=" width: 100%" value="<?php echo $TO[2];?>" readonly>
                    </div>
                    ...
                    <div class="col-lg-12" align="center">
                        <?php
                        $this->load->view('panel/MirAndesClinica/clinica_enfermeria/ingresos/tablas/formMedicamentos');
                        ?>
                    </div>
                    ...
                    <div class='col-lg-12'><br></div>
                        ...
                        <?php
                        $this->load->view('panel/MirAndesClinica/clinica_enfermeria/ingresos/tablas/formEvolucion');
                        ?>
...
$("#btnImprimir").click(function(){
    var evoId = $( "#evoId" ).val(); 
    location.href="<?php echo base_url(); ?>"+"hd_admision/fichas/imprimirEvolucion/"+evoId;
