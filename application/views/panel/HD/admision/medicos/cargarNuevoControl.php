...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
        ...
        <div class="col-lg-11" align="left">
            ...
            //echo var_dump($datos);
                echo form_open('hd_admision/medicos/guardarNuevoControl',$attributes);
            ?>
...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                ...
                <div class="col-lg-12"><br></div>
                    ...
                    <div class="col-lg-3">
                        <label>Edad: </label> <?php IF(!empty($control->edad)) echo $control->edad ;ELSE echo calculaedad($datos->fechaNacimiento);?>
                        <input type="hidden" name="edad" value="<?php IF(!empty($control->edad)) echo $control->edad; ELSE echo calculaedad($datos->fechaNacimiento);?>">
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <label>Isapre: </label> <?php IF(!empty($datos->isapreNombre))echo strtoupper($datos->isapreNombre); ?>
                    </div>
                    <div class="col-lg-5">
