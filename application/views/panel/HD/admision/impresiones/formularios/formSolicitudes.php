...
<div style="page-break-after: always;" >
        ...
        <blockquote>
            ...
            <div class="cubo21">&nbsp;&nbsp;
                ...
                <div><img style="position: relative; top:-80px; left: 80px; width:200px; max-height: 200px" src="<?php echo base_url();?>../assets/img/firmas/<?php echo $datosSol->solUsuario; ?>.png" ></div>
            </div>
            <br>
