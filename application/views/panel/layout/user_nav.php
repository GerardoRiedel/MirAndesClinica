        ...
        <div style="float: right; letter-spacing: 2px;" class="navCelu">
            <ul class="btn-group" style="border-left: none;" >
                ...
                <?php }ELSEIF ($this->session->userdata('perfil') === '6'){ ;?>
                    <li style="border-right: none;font-size: 23px ;text-align: center" class="btn cog"><a title="Editar Datos" class="tip-bottom" href="<?php echo base_url("clinica_admision/modificar/cargar_usuario/".$this->session->userdata('id_usuario'))?>"><i style="color: #ffffff" class="fa fa-cog"></i> </a></li>
