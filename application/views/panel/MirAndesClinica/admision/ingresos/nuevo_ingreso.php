...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
    ...
    <div class="col-lg-4">
        <table>
                            <tbody>
                            <tr>
                                <td style=" width: 30px" align="center"><div><input type="radio" name="ingresoAdministrativo" value="1" ></div></td>
                                <td style=" width: 75px">Si</td>
                                <td style=" width: 30px" align="center"><div><input type="radio" name="ingresoAdministrativo" checked="true"></div></td>
