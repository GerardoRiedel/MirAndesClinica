    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
        <br><div class="col-lg-12" align="center">
            ...
            <?php $attributes = array('id' => 'form');
                echo form_open('clinica_admision/devoluciones/guardarFichaDevolucion',$attributes);
            ?>
            ...
            <div class='widget-content'>
                ...
                <!-- DATOS DE PACIENTE-->               
                    ...
                    <?php IF(!empty($deposito)): ?>
                        <div class="col-lg-12" class="titulo">
                            <label>Deposito Vigente</label>
                        </div>
                        <div class="col-lg-2">
                            <label>Fecha Deposito</label>
                        </div>
                        <div class='col-lg-3'>
                            <label><?php echo $deposito->depFechaRegistro ?> </label>
                        </div>
                        <div class="col-lg-1">
                            <label>Monto</label>
                        </div>
                        <div class='col-lg-5'>
                            <label><?php echo $deposito->depSuma ?> </label>
                        </div>
                        <?php IF(!empty($deposito->depId) && !empty($registro)): ;?>
                        <div class="col-lg-2">
                        </div>
                        <div class="col-lg-5">
                            <a class="tip-bottom" title="Utilizar deposito Vigente" href="<?php echo base_url("clinica_admision/devoluciones/utilizarMismoDeposito/" . $registro.'_'.$deposito->depId.'_'.$deposito->depFichaElectro)?>"><i class="fa fa-pitem->ctaRegistrorint" aria-hidden="true">&nbsp;Utilizar Deposito Vigente</i></a>
                        </div>
                        <?php ENDIF; ?>
