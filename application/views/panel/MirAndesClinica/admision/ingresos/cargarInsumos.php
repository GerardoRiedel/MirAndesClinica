...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                ...
                <div class="col-lg-12">
                    ...
                    <div class='col-lg-10'>
                        ...
                        <input type="number" name="otroCodigo" minlength="6" maxlength="6" placeholder=" Código Examen" style="width: 140px;border-radius: 4px;background-image: none;border: 1px solid #CCCCCC;box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075) inset;height: 28px;">
                        <input type="number" name="otroValor" maxlength="6" placeholder=" Valor" style="width: 140px;border-radius: 4px;background-image: none;border: 1px solid #CCCCCC;box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075) inset;height: 28px;">
    ...
    <table class='table table-bordered table-hover table-striped' style="width: 700px">
        <thead>
            <tr>
                ...
                <td style="border-top:none" align="center"><b>COD EXAMEN</b></td>
        ...
        <tbody>
            ...
            <tr>
                    ...
                    <?php };?>
                    <td align="center"><?php IF(!empty($item->exaCodigo))echo $item->exaCodigo;?></td>
                    <td align="center"><?php IF($item->inaValor !== '0' && !empty($item->inaValor))echo '$ '.$item->inaValor; ?></td>
                    <td align="center"><?php echo $item->inaCantidad; ?></td>
    ...
    <table class='table table-bordered table-hover table-striped' style="border:1px solid grey;width: 680px">
        <thead>
            <tr>
                ...
                <td align="center"><b>COD EXAMEN</b></td>
                <td align="center"><b>VALOR</b></td>
                <td align="center"><b>CANTIDAD</b></td>
                <td align="center"><b>TOTAL</b></td>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                    ...
                    <?php };?>
                    <td align="center"><?php IF(!empty($item->exaCodigo))echo $item->exaCodigo;?></td>
                    <td style="border:1px solid grey" align="center"><?php IF($item->inaValor !== '0' && !empty($item->inaValor))echo '$ '.$item->inaValor; ?></td>
                    <td style="border:1px solid grey" align="center"><?php echo $item->inaCantidad; ?></td>
                    <td style="border:1px solid grey" align="center"><?php IF($item->inaValor !== '0' && !empty($item->inaValor))echo '$ '.$item->inaValor*$item->inaCantidad; ?></td>
                    <?php $total += ($item->inaValor*$item->inaCantidad);?>
