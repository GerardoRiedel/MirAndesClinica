...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_admision/ingresos/guardarModificarInsumoAsignado',$attributes);
            ?>
                            
            <div class='widget-content'>
                
                <br>
                        <input type="hidden" value="<?php IF(!empty($datos->inaId))echo $datos->inaId;?>" name="inaId">
                        <input type="hidden" value="<?php IF(!empty($datos->inaRegistro))echo $datos->inaRegistro;?>" name="registro">
...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
            ...
            -->
                    ...
                    <div class='col-lg-4'>
                        <input name="inaValor" style=" width: 90%" type="text" required value="<?php IF(!empty($datos->inaValor))echo $datos->inaValor; ?>">
                    </div>
