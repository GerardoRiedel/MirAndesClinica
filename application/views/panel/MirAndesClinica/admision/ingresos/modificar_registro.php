...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_admision/ingresos/guardarModificarRegistro',$attributes);
            ?>
            ...
            <div class='widget-content'>
                ...
                <br>
                    ...
                    <div class='col-lg-4'>
                        <input name="fechaDeribacion" type="text" value="<?php IF(!empty($datos->fechaDerivacion))echo $datos->fechaDerivacion;?>" readonly="true">
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class='col-lg-4'>
                       <div class="input-group input-group-sm date datepicker" required data-date="<?php //echo (new DateTime())->format('Y-m-d H:i:s') ?>" data-date-format="yyyy-mm-dd">
                            ...
                            <input type="text" class="form-control" required placeholder="día-mes-año" style=" width: 158px !important" name="fechaIngreso" minlength="10" maxlength="10" title="Ingrese una fecha valida" value="<?php IF(!empty($datos->fechaIngreso))echo $datos->fechaIngreso;?>">
                        </div>
                        <!--
                        <input type="text" placeholder="día-mes-año" name="fechaIngreso" value="<?php IF(!empty($datos->fechaIngreso))echo $datos->fechaIngreso;?>" >
                        -->
                    </div>
...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                    ...
                    <div class='col-lg-4'>
                        <input name="ficha" type="text" value="<?php echo $datos->ficha; ?>">
                    </div> 
    <div class="col-lg-12"></div>
                    <div class="col-lg-2">
    ...
    <div class="col-lg-4">
        <table>
                            <tbody>
                            <tr>
                                <td style=" width: 30px" align="center"><div><input type="radio" name="ingresoAdministrativo" value="1"  <?php IF(!empty($datos->ingresoAdministrativo)) echo 'checked'; ?>></div></td>
                                <td style=" width: 75px">Si</td>
                                <td style=" width: 30px" align="center"><div><input type="radio" name="ingresoAdministrativo"  <?php IF(empty($datos->ingresoAdministrativo)) echo 'checked'; ?>></div></td>
                ...
                <!-- DATOS DE PERSONALES-->               
                    ...
                    <div class='col-lg-4'>
                        <input name="nombres"  type="text" minlength="3" required id="nombres" value="<?php echo $datos->nombres; ?>">
                    </div>
                    <div class="col-lg-2">
                        <label>Apellido Paterno</label>
                    </div>
                    <div class='col-lg-4'>
                        <input name="apePat"  type="text" minlength="3" required id="apePat" value="<?php echo $datos->apellidoPaterno; ?>">
                    </div> 
                    <div class="col-lg-12" ></div>
                    <div class="col-lg-2">
                    ...
                    <div class='col-lg-4'>
                        <input name="apeMat"  type="text" minlength="3" required id="apeMat" value="<?php echo $datos->apellidoMaterno; ?>">
                    </div>     
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="input-group input-group-sm date datepicker" required data-date="<?php //echo (new DateTime())->format('Y-m-d H:i:s') ?>" data-date-format="yyyy-mm-dd">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            <input type="text" class="form-control" required placeholder="día-mes-año" style=" width: 158px !important" name="fecha" id="fecha" minlength="10" maxlength="10" title="Ingrese una fecha valida" value="<?php echo $datos->fechaNacimiento; ?>">
                        </div>
                        <!--
                ...
                <!-- DATOS DE CONTACTO-->            
                    ...
                    <div class='col-lg-4'>
                        <input name="emergenciaDerivar"  type="text" required id="emergenciaDerivar" required value="<?php IF(!empty($datos->emergenciaDerivar))echo str_replace('%20',' ',$datos->emergenciaDerivar); ?>">
                    </div>
                    <!-- OTRO CONTACTO-->    
                    ...
                    <div class='col-lg-4'>
                        <input type="text" minlength="3" name="nombreOtroContacto" value="<?php IF(!empty($nombreOtroContacto))echo $nombreOtroContacto; ?>">
                    </div>
                    <div class="col-lg-2">
                ...
                <div class="col-lg-2">
                    ...
                    <div class='col-lg-4'>
                        <select name="medicoAsignado" id="medicoAsignado">
                            ...
                            <option value="<?php echo $med->id; ?>" <?php IF ($datos->medicoAsignado === $med->id)echo 'selected';?>><?php echo strtoupper($med->apellidoPaterno).' '.strtoupper($med->apellidoMaterno).' '.strtoupper($med->nombres); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class='col-lg-4'>
                        <select name="regimen" required id="regimen">
                            ...
                            <option value="<?php echo $reg->regId;?>" <?php IF ($datos->regimen === $reg->regNombre)echo 'selected';?>><?php echo $reg->regNombre;?></option>
                            <?php }; ?>
                        </select>
                    </div>
                    ...
                    <div class='col-lg-10'>
                        <input name="diagnostico" id="diagnostico" style=" width: 84%;" type="text" value="<?php IF(!empty($datos->diagnostico))echo str_replace('%20',' ',$datos->diagnostico);?>">
                    </div>
                    <div class="col-lg-12"></div>
                    <div class="col-lg-2">
                    ...
                    <div class='col-lg-10' style="margin-top: 10px">
                        <input name="comentario" style=" width: 84%;" type="text" id="comentario" value="<?php IF(!empty($datos->comentario))echo str_replace('%20',' ',$datos->comentario);?>"><h7 style=" font-size: 8px"> (campo no obligatorio)</h7>
                    </div>
                <!-- FIN DATOS CLINICOS-->         
...
<div id="divFichaApoderado"><!--INICIO DIVFICHA APODERADO-->
                    ...
                    <div class='col-lg-4'>
                        <input name="nombresApo"  type="text" minlength="3" required id="nombresApo" value="<?php echo $apoNombre ?>" >
                    </div>
                    <div class="col-lg-2">
                        <label>Apellido Paterno</label>
                    </div>
                    <div class='col-lg-4'>
                        <input name="apePatApo"  type="text" minlength="3" required id="apePatApo" value="<?php echo $apoApePat ?>">
                    </div> 
                    <div class="col-lg-12"></div>
                    ...
                    <div class='col-lg-4'>
                        <input name="apeMatApo"  type="text" minlength="3" required id="apeMatApo" value="<?php echo $apoApeMat ?>">
                    </div> 
                    ...
                    <div class='col-lg-4'>
                        <input name="emailApo"  type="text" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" title="mail@ejemplo.com" minlength="9" id="emailApo" value="<?php echo $apoEmail ?>">
                    </div>
                    <div class="col-lg-2">
                        <label>Parentesco</label>
                    </div>
    ...
    <div id="divFichaEconomico"><!--INICIO DIV FICH APODERADO ECONOMICO -->
                    ...
                    <div class='col-lg-4'>
                        <input name="nombresApoEco"  type="text" minlength="3" required id="nombresApoEco" value="<?php echo $ecoNombre; ?>">
                    </div>
                    <div class="col-lg-2">
                        <label>Apellido Paterno</label>
                    </div>
                    <div class='col-lg-4'>
                        <input name="apePatApoEco"  type="text" minlength="3" required id="apePatApoEco" value="<?php echo $ecoApePat; ?>">
                    </div> 
                    <div class="col-lg-12"></div>
                    <div class="col-lg-6"></div>
                    <div class="col-lg-2">
                    ...
                    <div class='col-lg-4'>
                        <input name="apeMatApoEco"  type="text" minlength="3" required id="apeMatApoEco" value="<?php echo $ecoApeMat; ?>">
                    </div> 
                    <div class="col-lg-12"></div><!--SALTO DE LINEA-->
                    <div class="col-lg-2">
                        <label>Dirección</label>
                    ...
                    <div class='col-lg-4'>
                        <input name="emailApoEco"  type="text" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" title="mail@ejemplo.com" minlength="9" id="emailApoEco" value="<?php echo $ecoEmail; ?>">
                    </div>
                    <div class="col-lg-2">
                        <label>Parentesco</label>
                    </div>
...
<div>
                    ...
                    <div class='col-lg-4'>
                        <input name="nombresDev"  type="text" minlength="3" required id="nombresDev" value="<?php IF(!empty($devolucion->ctaNombre))echo $devolucion->ctaNombre; ?>">
                    </div>
                    <div class="col-lg-12" ></div><!--SALTO DE LINEA-->
                    <div class="col-lg-2">
                        <label>Apellido Paterno</label>
                    ...
                    <div class='col-lg-4'>
                        <input name="apePatDev"  type="text" minlength="3" required id="apePatDev" value="<?php IF(!empty($devolucion->ctaApellido))echo $devolucion->ctaApellido; ?>">
                    </div>
                    <div class="col-lg-2">
                        <label>Apellido Materno</label>
                    </div>
                    <div class='col-lg-4'>
                        <input name="apeMatDev"  type="text" minlength="3" required id="apeMatDev" value="<?php IF(!empty($devolucion->ctaApellidoM))echo $devolucion->ctaApellidoM; ?>">
                    </div>
                    <div class="col-lg-12" ></div><!--SALTO DE LINEA-->
                    <div class="col-lg-2">
                        <label>Banco</label>
...
<script>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (data.rut != undefined && data.rut != '0'){}
               }
        })
        })
