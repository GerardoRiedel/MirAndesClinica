...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_admision/salidas/guardarSalida',$attributes);
            ?>
            ...
            <div class='widget-content'>
                ...
                <div class="col-lg-12"></div>
                    ...
                    <div class='col-lg-4'>
                        <input name="horaIngreso" type="timer" class="datetimepicker" style=" min-width: 190px" required value="<?php IF(!empty($datos->horaIngreso))echo $datos->horaIngreso;?>" readonly>
                    </div>
                    <div class="col-lg-12"></div>
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-12"></div>
                    <div class="col-lg-2">
                        <label>Dar Alta del Sistema</label>
                    </div>
                    <div class='col-lg-4'>
