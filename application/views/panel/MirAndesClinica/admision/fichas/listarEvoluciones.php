...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                ...
                <div class="col-lg-12"><br></div>
                    ...
                    <div class="col-lg-4">
                    <label>Alergias: </label> <h7 style="color:red;font-size:20px"><b><?php IF(!empty($datos->alergia))echo strtoupper($datos->alergia);ELSE echo '.....................' ?></b></h7>
                     <!--   
            ...
            <!-- DATOS DE CLINICOS-->  
                    <div class="col-lg-12">
                    <label class="titulo">Datos de Evoluciones</label>
                    </div> 
                    <div class="col-lg-12">
                        <table class='table table-bordered table-hover table-striped'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $evo->evoFechaRegistro;?></td>
                                    <td><?php echo $evo->uspNombre.' '.$evo->uspApellidoP;?></td>
                                    <td align="center">
                                    <a class="tip-bottom" title="Ver Registro de Evolución" href="<?php echo base_url("clinica_admision/fichas/cargarEvolucion/" . $evo->evoId )?>"><i class="fa fa-hand-o-right" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                <?php };?>
                            </tbody>
