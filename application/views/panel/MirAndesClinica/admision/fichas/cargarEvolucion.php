...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25; background-color: #db8918">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_admision/ingresos/guardarNuevoRegistro',$attributes);
            ?>
...
$("#btnImprimir").click(function(){
    var evoId = $( "#evoId" ).val(); 
    location.href="<?php echo base_url(); ?>"+"clinica_admision/fichas/imprimirEvolucion/"+evoId;
