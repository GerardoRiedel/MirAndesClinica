                ...
                <tr>
                    ...
                    <td style="width:85px"align="center">
                        <?php IF($eva->evaProceso==='Intervensión'){ //echo $eva->evaId;?>
                            <a class="tip-bottom" title="Imprimir Evaluación" href="<?php echo base_url("clinica_admision/impresiones/imprimirEvaluacion/".$eva->evaId )?>"><i class="fa fa-print" aria-hidden="true"></i></a>
                        <?php }ELSEIF($eva->evaProceso==='Evolución Médica') { ?>
                            <a class="tip-bottom" title="Imprimir Evolución Médica" href="<?php echo base_url("clinica_admision/impresiones/imprimirEvolucionMedica/".$eva->evaId )?>"><i class="fa fa-print" aria-hidden="true"></i></a>
                        <?php } ELSE { ?>
                            <a class="tip-bottom" title="Imprimir Antecedentes" href="<?php echo base_url("clinica_admision/impresiones/cargarImprimir/".$eva->registro )?>"><i class="fa fa-print" aria-hidden="true"></i></a>
                       
                        <?php } ?>
                        <!--
                        <a class="tip-bottom" title="Imprimir Evaluación" href="<?php echo base_url("clinica_admision/impresiones/imprimirEvaluacion/".$eva->evaId )?>"><i class="fa fa-print" aria-hidden="true"></i></a>&nbsp;&nbsp;
                        
                        <a class="tip-bottom" title="Modificar Evaluación" href="<?php echo base_url("clinica_admision/ingresos/modificarEvaluacion/" . $eva->evaId )?>"><i class="fas fa-edit" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
