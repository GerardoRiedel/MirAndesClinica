...
<div style="page-break-after: always;">
        ...
        <blockquote><blockquote>
            <div class="col-lg-12" align="center">
                <h2>AUTORIZACIÓN EN CASO DE URGENCIAS O EMERGENCIAS MÉDICAS NO PSIQUIÁTRICAS</h2>
            </div>
        </blockquote></blockquote>
        <blockquote>
            <div align="justify" style="line-height: 24px">
                <br><br><br>
                Para que el usuario de Mirandes Clínica pueda recibir una atención fluida y de calidad, es fundamental dejar estipulado desde el ingreso qué hacer en caso de una <b>Urgencia o Emergencia Médica no Psiquiátrica</b>.
                <br><br>
                Por lo anterior es que le solicitamos que a continuación nos entregue los siguientes datos y autorización.
                <br><br><br>
                Yo <b><?php echo strtoupper($apoNombre).' '.strtoupper($apoApePat).' '.strtoupper($apoApeMat);?></b>. Rut <b><?php IF(!empty($apoRut))echo formatearRut($apoRut); ?></b>, <b><?php echo strtoupper($apoParentesco);?></b>. Autorizo a MirAndes Clínica para llamar en caso de Emergencia o Urgencia médica del usuario <b><?php echo strtoupper($datos->nombres).' '.strtoupper($datos->apellidoPaterno).' '.strtoupper($datos->apellidoMaterno);?></b>.
                Rut <b><?php echo formatearRut($datos->rut);?></b>, a la ambulancia .......................................................................... y trasladarlo al Servicio de Urgencia de la Clínica u Hospital <?php IF(!empty($datos->emergenciaDerivar))echo '<b>'.strtoupper($datos->emergenciaDerivar).'</b>';ELSE echo '_____________________________________________'; ?>.
