...
<div class="espacio">
                ...
                <div style="page-break-before: always;">
                    <br>
                    <div class="col-lg-10" align="left" style="margin-left: 55px;margin-top: -6px">
                        <img src="<?php echo base_url();?>../assets/img/minsalX50X63px.jpg" class="logo">
                    </div>
                    <div class="col-lg-10" align="center" style="margin-top: -55px">
                        <h3>INFORME ESTADÍSTICO DE EGRESO HOSPITALARIO</h3>
                    </div>
                    <div class="col-lg-10" align="right" style=" margin-right: 50px;margin-top: -40px">
                        <img src="<?php echo base_url();?>../assets/img/deisX70.jpg" class="logo">
                    </div>
                    <br><br><br>
                    ...
                    <!-- PRIMER LADO NEGRO -->    
                        ...
                        <div class="di" style=" margin-top:5px">
                            ...
                            <div style="position: absolute;left:588px;top:155px">DÍA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MES&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AÑO</div>
                            ...
                            <div style="position: absolute;left:70px;top:330px;width: 50px;">PREVISIÓN<br><br><br><br>EN<br><br><br><br>SALUD</div>
                            <div style="position: absolute;left:150px;top:325px;width: 50px;">
                                <table style="border: none; font-size: 9px">
                            ...
                            <div style="position: absolute;left:285px;top:325px;width: 50px;">
                                <table style="border: none; font-size: 9px">
                            ...
                            <div style="position: absolute;left:405px;top:325px;width: 50px;">
                                <table style="border: none; font-size: 9px">
                            ...
                            <div style="position: absolute;left:503px;top:325px;width: 50px;">
                    ...
                    <!-- SEGUNDO LADO NEGRO -->    
                        ...
                        <div class="di" style=" margin-top:5px"><br>
                            ...
                            ?>
                            INGRESO<input class="cubo" style="margin-left:10px" value="<?php echo substr($hora,-8,1);?>"><input class="cubo" value="<?php echo substr($hora,-7,1);?>">:<input class="cubo" value="<?php echo substr($hora,-5,1);?>"><input class="cubo" value="<?php echo substr($hora,-4,1);?>">&nbsp;<input class="cubo" value="<?php echo substr($fecha,-2,1);?>"><input class="cubo" value="<?php echo substr($fecha,-1,1);?>">&nbsp;<input class="cubo" value="<?php echo substr($fecha,-5,1);?>"><input class="cubo" value="<?php echo substr($fecha,-4,1);?>">&nbsp;<input class="cubo" value="<?php echo substr($fecha,-8,1);?>"><input class="cubo" value="<?php echo substr($fecha,-7,1);?>">&nbsp;................................................................................................................................................................ <input class="cubo"><input class="cubo"><input class="cubo">
                            <?php ELSE: ?>
                            ...
                            PRIMER TRASLADO<input class="cubo" style="margin-left:39px"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;................................................................................................................................................................ <input class="cubo"><input class="cubo"><input class="cubo">
                            <br>
                            <span style="position: relative; top:4px;"><img src="<?php echo base_url();?>../assets/img/negro.png" style="border-radius: 2px;width:16px; height:16px; border: 0px; padding: 0" /></span>
                            <span style="position: relative; left:-16px; color:white;font-size: 11px"><b>23</b></span>
                            SEGUNDO TRASLADO<input class="cubo" style="margin-left:30px"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;................................................................................................................................................................ <input class="cubo"><input class="cubo"><input class="cubo">
                            <br>
                            <span style="position: relative; top:4px;"><img src="<?php echo base_url();?>../assets/img/negro.png" style="border-radius: 2px;width:16px; height:16px; border: 0px; padding: 0" /></span>
                            <span style="position: relative; left:-16px; color:white;font-size: 11px"><b>24</b></span>
                            TERCER TRASLADO<input class="cubo" style="margin-left:37px"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;................................................................................................................................................................ <input class="cubo"><input class="cubo"><input class="cubo">
                            <br>
                            <span style="position: relative; top:4px;"><img src="<?php echo base_url();?>../assets/img/negro.png" style="border-radius: 2px;width:16px; height:16px; border: 0px; padding: 0" /></span>
                            <span style="position: relative; left:-16px; color:white;font-size: 11px"><b>25</b></span>
                            CUARTO TRASLADO<input class="cubo" style="margin-left:37px"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;................................................................................................................................................................ <input class="cubo"><input class="cubo"><input class="cubo">
                            <br>
                            <span style="position: relative; top:4px;"><img src="<?php echo base_url();?>../assets/img/negro.png" style="border-radius: 2px;width:16px; height:16px; border: 0px; padding: 0" /></span>
                            ...
                            ?>
                            EGRESO<input class="cubo" style="margin-left:14px" value="<?php echo substr($hora,-8,1);?>"><input class="cubo" value="<?php echo substr($hora,-7,1);?>">:<input class="cubo" value="<?php echo substr($hora,-5,1);?>"><input class="cubo" value="<?php echo substr($hora,-4,1);?>">&nbsp;<input class="cubo" value="<?php echo substr($fecha,-2,1);?>"><input class="cubo" value="<?php echo substr($fecha,-1,1);?>">&nbsp;<input class="cubo" value="<?php echo substr($fecha,-5,1);?>"><input class="cubo" value="<?php echo substr($fecha,-4,1);?>">&nbsp;<input class="cubo" value="<?php echo substr($fecha,-8,1);?>"><input class="cubo" value="<?php echo substr($fecha,-7,1);?>">&nbsp;................................................................................................................................................................ <input class="cubo"><input class="cubo"><input class="cubo">
                            <?php ELSE: ?>
                            EGRESO<input class="cubo" style="margin-left:14px"><input class="cubo">:<input class="cubo"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;<input class="cubo"><input class="cubo">&nbsp;................................................................................................................................................................ <input class="cubo"><input class="cubo"><input class="cubo">
                            <?php ENDIF; ?>
                            <br>
                            <span style="position: relative; top:4px;"><img src="<?php echo base_url();?>../assets/img/negro.png" style="border-radius: 2px;width:16px; height:16px; border: 0px; padding: 0" /></span>
                            <span style="position: relative; left:-16px; color:white;font-size: 11px"><b>27</b></span>
                            DÍAS DE ESTADA<input class="cubo" style="margin-left:20px"><input class="cubo"><input class="cubo"><input class="cubo">
                            <span style="position: relative; top:4px;"><img src="<?php echo base_url();?>../assets/img/negro.png" style="border-radius: 2px;width:16px; height:16px; border: 0px; padding: 0" /></span>
                            <span style="position: relative; left:-16px; color:white;font-size: 11px"><b>28</b></span>
                            <input class="cubo" style="margin-left:50px">
                            
                            <div style="position: absolute;left:655px;top:482px;width: 70px;font-size: 6px">CÓDIGO<br><br><br><br>SERVICIO CLÍNICO</div>
                            <div style="position: absolute;left:259px;top:625px;width: 70px;font-size: 8px">CONDICIÓN AL<br><br><br><br>EGRESO</div>
                            <div style="position: absolute;left:340px;top:625px;width: 70px;font-size: 8px">1) Vivo<br><br><br><br>2) Fallecido</div>
                        </div>
                        <br><br><br>
                        ...
                        <div class="di" style=" margin-top:5px">
                            ...
                            <div style="position: absolute;left:645px;top:644px;width: 70px;font-size: 6px">CÓDIGO CIE-10</div>
                        </div>
                        <br><br>
                        ...
                        <div style=" margin-left:-25px">
                            <b>DATOS DEL MÉDICO O PROFESIONAL</b><br>
                            <div class="di">
                                <span style="position: relative; top:4px;"><img src="<?php echo base_url();?>../assets/img/negro.png" style="border-radius: 2px;width:16px; height:16px; border: 0px; padding: 0" /></span>
                        ...
                        <span style="position: relative; top:0px;left:-25px"><img src="<?php echo base_url();?>../assets/img/negro.png" style="width:705px; height:8px; border: 0px; padding: 0" /></span>
                        <span style="position: relative; left:25px;top:-6px;color:white;font-size: 7px"><b>INFORMACIÓN PROTEGIDA POR LEY N°19.628 SOBRE PROTECCIÓN DE LA VIDA PRIVADA Y CON GARANTÍA DEL SECRETO ESTADÍSTICO, ESTABLECIDO EN LA LEY N°17.374</b></span>
