...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25; background-color: #db8918">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_admision/impresiones/imprimirImprimir',$attributes);
            ?>
...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                ...
                <div>
                    ...
                    <div class='col-lg-1' align="right">
                        <input name="formExamenes" type="checkbox" id="formExamenes">
                    </div>
                    <div class="col-lg-6">
                        <label>Formulario Exámenes de Laboratorio</label>
                    </div>
...
//die(var_dump($datos));
    echo form_open('clinica_admision/impresiones/imprimirImprimirEnfermeria',$attributes);
?>
<input type="hidden" value="<?php echo $datos->id;?>" name="fichaElectro">
<input type="hidden" value="<?php echo $datos->rut;?>" name="rut">
<div class="col-lg-12">
...
<script>
    ...
    var diez = $('#formExamenes').prop('checked');
    
    if(diez === false && nueve === false && ocho === false && siete === false && cero === false && uno === false && dos === false && cinco === false && seis === false) {  
