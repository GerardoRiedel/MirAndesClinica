    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
                ...
                <a href="<?php echo base_url("clinica_admision/herramientas/cargar_farmacos/")?>" style="color: #da812e; font-size: 30px; padding-top: -30px;margin-top:-30px;margin-bottom: 5px;margin-left: 25px" title="Agregar Fármaco"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
