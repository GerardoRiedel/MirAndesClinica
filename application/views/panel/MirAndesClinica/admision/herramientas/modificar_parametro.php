...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_admision/herramientas/guardarModificarParametro',$attributes);
            ?>
                            
            <div class='widget-content'>
                
                <br>
                        <input type="hidden" value="<?php IF(!empty($datos->parId))echo $datos->parId;?>" name="parId">
                
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                    
            <!-- DATOS DE PERSONALES-->               
                    <div class="col-lg-12" style=" margin-bottom: 10px">
                    <label class="titulo">Datos de Parámetro</label>
                    </div>
                    <div class="col-lg-3">
                        <label>Nombre del parámetro</label>
                    </div>
                    <div class='col-lg-3'>
                        <input name="parNombre" readonly="true" type="text" required value="<?php echo $datos->parNombre; ?>">
                    </div>
                    ...
                    <div class='col-lg-5'>
                        <input name="parValor" style=" width: 90%" type="text" required value="<?php IF(!empty($datos->parValor))echo $datos->parValor; ?>">
                    </div> 
