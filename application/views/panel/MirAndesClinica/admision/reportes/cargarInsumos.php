...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 bhoechie-tab-container navCeluSession"  >
        ...
        <div  class="col-lg-12">
                    ...
                    <?php $attributes = array('id' => 'form');
                        echo form_open('clinica_admision/reportes/filtroCargarEgresos',$attributes);
                    ?>
                    <br>
                    </div>
                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $item->inaBoleta; ?></td>
...
<script>
    $("#btnExport").click(function(e) {
        ...
        tmpElemento.download = 'Registros de Insumos.xls';
