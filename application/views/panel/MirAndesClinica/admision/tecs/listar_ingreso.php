                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a class="tip-bottom" title="Imprimir consentimiento T.E.C" href="<?php echo base_url("clinica_admision/impresiones/imprimirImprimirTEC/" . $item->tecId )?>"><i class="fa fa-print" aria-hidden="true"></i></a>&nbsp;&nbsp;
                                </td>
                                <td align="center">
