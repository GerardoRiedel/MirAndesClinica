                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a class="tip-bottom" title="Ingreso de Visitas" href="<?php echo base_url("clinica_admision/visitas/cargarVisita/" . $item->id )?>"><i class="fa fa-user-plus" aria-hidden="true"></i></a>&nbsp;&nbsp;
                                </td>
                            </tr>
                                <?php endforeach; ?>
                        </tbody>
