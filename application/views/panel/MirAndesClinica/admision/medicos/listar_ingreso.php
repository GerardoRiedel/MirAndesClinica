                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        <thead>
                            <tr>
                                ...
                                <th>Apellidos</th>
                                <th>Piso</th>
                                <th  aling="center"><table><tr><td style="min-width:65px">Evolución<br>Tens</td></tr></table></th>
                                <th  aling="center"><table><tr><td style="min-width:65px">Control<br>Médico</tr></table></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $item->piso;?></td>
                                <td align="center">
                                    <a class="tip-bottom" title="Evolución Diaria Tens" href="<?php echo base_url("clinica_enfermeria/ingresos/cargarNuevoRegistro/" . $item->id )?>"><i class="fa fa-sun-o" aria-hidden="true"></i></a>
                                </td>
                                <td align="center">
