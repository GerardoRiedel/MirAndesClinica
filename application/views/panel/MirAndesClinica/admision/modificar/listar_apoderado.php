    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
                ...
                <div class='widget-title'>
                    ...
                    <?php $attributes = array('id' => 'form');
                        echo form_open('clinica_admision/modificar/filtrar_apoderado',$attributes);
                    ?>
                    <br>
                    <div class="col-lg-1">
                        <label>Filtrar</label>
                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo strtoupper($item->pNombre).' '.strtoupper($item->pApellido) ?></td>
                                <?php 
                                    $apoTipo = $item->apoTipo;
