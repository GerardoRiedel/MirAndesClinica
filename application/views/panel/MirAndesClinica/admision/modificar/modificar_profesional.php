...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_admision/modificar/guardarModificarProfesional',$attributes);
            ?>
                            
            <div class='widget-content'>
                
                <br>
                    <input type="hidden" value="<?php IF(!empty($datos->id))echo $datos->id;?>" name="id">
                
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                    
            <!-- DATOS DE PERSONALES-->               
                    <div class="col-lg-12" style=" margin-bottom: 10px">
                    <label class="titulo">Datos de Profesional</label>
                    </div>
                    <div class="col-lg-1">
                        <label>Run</label>
                    </div>
                    <div class='col-lg-2'>
                        <input name="rut" class="in" type="text" placeholder="Digite rut de usuario" minlength="7" required value="<?php IF(!empty($datos->rut))echo formatearRut($datos->rut);?>">
                    </div>
                    <div class="col-lg-2">
                        <label>Email</label>
                    </div>
                    <div class='col-lg-2'>
                        <input name="email" class="in" placeholder="mail@ejemplo.cl" type="text" minlength="4" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" title="mail@ejemplo.com"  required value="<?php IF(!empty($datos->email))echo $datos->email; ?>">
                    </div>
                    ...
                    <div class='col-lg-2'>
                        <input name="nombre" class="in" type="text" placeholder="Ingrese Nombre" minlength="4" required value="<?php IF(!empty($datos->nombres))echo $datos->nombres; ?>">
                    </div>
                    <div class="col-lg-2">
                        <label>Apellido Paterno</label>
                    </div>
                    <div class='col-lg-2'>
                        <input name="apellidoP" class="in" type="text" placeholder="Ingrese Apellido Paterno" minlength="4" required value="<?php IF(!empty($datos->apellidoPaterno))echo $datos->apellidoPaterno; ?>">
                    </div> 
                    <div class="col-lg-2">
                        <label>Apellido Materno</label>
                    </div>
                    <div class='col-lg-2'>
                        <input name="apellidoM" class="in" type="text" placeholder="Ingrese Apellido Materno" minlength="4" required value="<?php IF(!empty($datos->apellidoMaterno))echo $datos->apellidoMaterno; ?>">
                    </div>     
                    <div class="col-lg-12" ></div>
