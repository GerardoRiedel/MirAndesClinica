                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a class="tip-bottom" title="Modificar Profesional" href="<?php echo base_url("clinica_admision/modificar/cargar_profesional/" . $item->id )?>"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                                <?php endforeach; ?>
                        </tbody>
