    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
                ...
                <a href="<?php echo base_url("clinica_admin/herramientas/cargar_farmacos/")?>" style="color: #da812e; font-size: 30px; padding-top: -30px;margin-top:-30px;margin-bottom: 5px;margin-left: 25px" title="Agregar Fármaco"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
                <table class='table table-bordered table-hover table-striped'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a class="tip-bottom" title="Modificar parámetro" href="<?php echo base_url("clinica_admin/herramientas/cargar_farmacos/".$item->idfarmaco )?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                                <?php endforeach; ?>
                        </tbody>
