    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
                ...
                <a href="<?php echo base_url("clinica_admin/modificar/cargar_usuario/")?>" style="color: #da812e; font-size: 30px; padding-top: -30px;margin-top:-30px;margin-bottom: 5px;margin-left: 25px" title="Agregar Usuario"><i class="fa fa-user-plus" aria-hidden="true"></i></a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style=" color :<?php echo $color ?>" align="center">
                                    ...
                                    <a class="tip-bottom" title="Desactivar usuario" style=" color: green; margin-bottom: 0px"  href="<?php echo base_url("clinica_admin/modificar/desactivar_usuario/".$item->uspId )?>">Activo<!--<i class="fa fa-ban" aria-hidden="true"></i>--></a>
                                    
                                    <?php }ELSEIF($this->session->userdata('perfil') === '1' && $item->uspEstado === '2') { ;?>
                                    <a class="tip-bottom" title="Activar usuario" style=" color: red" href="<?php echo base_url("clinica_admin/modificar/activar_usuario/".$item->uspId )?>">Desactivo<!--<i class="fa fa-check" aria-hidden="true"></i>--></a>
                                    <?php } ?>
                                
                                </td>
                                <td style=" color :<?php echo $color ?>" align="center">
                                    <?php IF($item->uspEstado === '1'): ?>
                                    <a class="tip-bottom" title="Modificar usuario" href="<?php echo base_url("clinica_admin/modificar/cargar_usuario/".$item->uspId )?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    <?php ENDIF; ?>
                                </td>
                            </tr>
                                <?php endforeach; ?>
