                ...
                <table class='table table-bordered table-hover table-striped'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <?php IF($item->depTipo === '1')$tipo='Efectivo'; ELSEIF($item->depTipo === '2')$tipo='Cheque'; ELSEIF($item->depTipo === '3')$tipo='Transferencia';ELSEIF($item->depTipo === '4')$tipo='WebPay';ELSEIF($item->depTipo === '5')$tipo='T Crédito';ELSEIF($item->depTipo === '6')$tipo='T Débito';ELSE $tipo = $item->depTipo;?>
                                ...
                                <td align="center">
                                    ...
                                    <?php ENDIF; ?>
                                    <a class="tip-bottom" title="Agregar Deposito" href="<?php echo base_url("clinica_admision/devoluciones/agregarDeposito/" . $item->ctaRegistro )?>"><i class="fa fa-money" aria-hidden="true"></i></a>
                                </td>
                                <td align="center">
