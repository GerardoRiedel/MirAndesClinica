...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            <?php $attributes = array('id' => 'form');
                echo form_open('clinica_admin/devoluciones/guardarDeposito',$attributes);
            ?>
            ...
            <div id="divEco">
                    ...
                    <!--
                        <input name="rutApoEco" type="text" minlength="7" id="rutApoEco" >
                    -->
                    </div> 
    ...
    <div id="divFichaEconomico"><!--INICIO DIV FICH APODERADO ECONOMICO -->
                    ...
                    <div class='col-lg-4'>
                        <?php IF(!empty($apoderado))echo $apoderado->apoNombre;?>
                        <!--
                    ...
                    <div class='col-lg-4'>
                        <?php IF(!empty($apoderado))echo $apoderado->apoApePat;?><?php IF(!empty($apoderado))echo $apoderado->apoApeMat;?>
                        <!--
                    ...
                    <div class='col-lg-4'>
                        <?php IF(!empty($apoderado))echo $apoderado->apoDireccion;?>
                        <!--
                    ...
                    <div class='col-lg-4'>
                        <?php IF(!empty($apoderado))echo $apoderado->apoEmail;?>
                        <!--
                    ...
                    <div class='col-lg-4'>
                        <?php 
                            ...
                            ELSEIF($apoderado->apoParentesco === '4')echo 'Conyuge';
                            ELSEIF($apoderado->apoParentesco === '5')echo 'Hermano/a';
                            ELSEIF($apoderado->apoParentesco === '6')echo 'Tío/a';
                            ELSEIF($apoderado->apoParentesco === '7')echo 'Primo/a';
...
<!--INICIO DEVOLUCIONES-->
                    ...
                    <div class='col-lg-4'>
                        <?php IF(!empty($ctaDevolucion))echo $ctaDevolucion->ctaNombre;?> <?php IF(!empty($ctaDevolucion))echo $ctaDevolucion->ctaApellido;?> <?php IF(!empty($ctaDevolucion))echo $ctaDevolucion->ctaApellidoM;?>
                        <!--
                    ...
                    <div class='col-lg-4'>
                        <?php IF(!empty($ctaDevolucion))echo $ctaDevolucion->banNombre;?> 
                        <!--
                    ...
                    <div class='col-lg-4' >
                        <?php IF(!empty($ctaDevolucion))echo $ctaDevolucion->tipNombre;?> 
                        <!--
                    ...
                    <div class='col-lg-4'>
                        ...
                        <!--
                        <input name="NCta" type="text" minlength="4" required id="NCta">
                        -->
                    </div>
                    <div class="col-lg-2">
                        <label>Email</label >
                    ...
                    <div class='col-lg-4'>
                        <?php IF(!empty($ctaDevolucion))echo $ctaDevolucion->ctaEmail;?> 
                        <!--
                        <input name="emailDev" type="text" minlength="9" required id="emailDev">
                        -->
                    </div>
