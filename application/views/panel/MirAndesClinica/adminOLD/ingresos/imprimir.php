                    ...
                    //die(var_dump($datosApo[0]));
                        ...
                        IF(empty($datosApo[0]->apoRut) && !empty($datosApo[1]->apoRut)){
                            foreach ($datosApo[1] as $apo){
                                ...
                                IF($apoParentesco  === '1')$apoParentesco = 'Padre';ELSEIF($apoParentesco  === '2')$apoParentesco = 'Madre';ELSEIF($apoParentesco  === '3')$apoParentesco = 'Hijo';ELSEIF($apoParentesco  === '4')$apoParentesco = 'Conyuge';ELSEIF($apoParentesco  === '5')$apoParentesco = 'Hermano/a';ELSEIF($apoParentesco  === '6')$apoParentesco = 'Tío';ELSEIF($apoParentesco  === '7')$apoParentesco = 'Primo/a';ELSE$apoParentesco = 'Otro';
                                $ecoRut         = $apoRut;
                                $ecoNombre      = $apoNombre;
                                $ecoApePat      = $apoApePat;
...
<div class='widget-content' id="imprimir">
                ...
                <div class="col-lg-12" align="center">
                    <h2>ALERGIAS: <?php IF (!empty($datos->alergia))echo $datos->alergia; ELSE echo '..........';?>&nbsp;&nbsp;&nbsp;&nbsp;N° FICHA: <?php echo $datos->ficha; ?>&nbsp;&nbsp;&nbsp;&nbsp;N° PISO: <?php IF(!empty($datos->piso))echo $datos->piso;ELSE echo '..........' ?></h2>
                </div>
                <div class="col-lg-12" align="center">
