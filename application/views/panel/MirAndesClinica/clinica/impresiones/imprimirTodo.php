...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_enfermeria/impresiones/imprimirImprimir',$attributes);
            ?>
...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                ...
                <div>
                    ...
                    <div class='col-lg-12' ></div>
                    <div class='col-lg-1' align="right">
                        <input name="formVisita" type="checkbox" id="formVisita">
                    </div>
                    <div class="col-lg-4">
                        <label>Formulario de Visitas</label>
                    </div>
...
//die(var_dump($datos));
    echo form_open('clinica_enfermeria/impresiones/imprimirImprimirEnfermeria',$attributes);
?>
<input type="hidden" value="<?php echo $datos->id;?>" name="fichaElectro">
<input type="hidden" value="<?php echo $datos->rut;?>" name="rut">
<div class="col-lg-12">
...
<div class='col-lg-1' align="right">
    <input name="formSuicida" type="checkbox" id="formSuicida">
</div>
<div class="col-lg-6">
    <label>Escala de Riesgos Suicida</label>
</div>
<div class="col-lg-12"></div>
<div class="col-lg-5"></div>
<div class='col-lg-1' align="right">
    <input name="formDowton" type="checkbox" id="formDowton">
</div>
<div class="col-lg-6">
    <label>Escala de Riesgos de Caidas Dowton</label>
</div>
<div class="col-lg-12"></div>
<div class='col-lg-1' align="right">
    <a href="<?php echo base_url("clinica_enfermeria/medicos/listarEvoluciones/" . $datos->id )?>" ><i class="fa fa-heartbeat" aria-hidden="true"></i></a>
</div>
<div  class="col-lg-6">
    <label><a href="<?php echo base_url("clinica_enfermeria/medicos/listarEvoluciones/" . $datos->id )?>" >ver evoluciones</a></label>
</div>
...
$("#form2").submit(function () {  
    var siete = $('#formEnfermeria').prop('checked');
     var siete2 = $('#formSuicida').prop('checked');
      var siete3 = $('#formDowton').prop('checked');
    if(siete === false && siete2 === false && siete3 === false){
    alert("Seleccione un formulario a imprimir");  
        return false;
    } 
}); 
