...
<?php IF($opciones[15] === 'on'):?>
                <!-- INICIO FORMULARIO SUICIDA -->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formSuicida');
                ?>
                <!-- INICIO FORMULARIO SUICIDA -->
<?php ENDIF; ?>
<?php IF($opciones[16] === 'on'):?>
                <!-- INICIO FORMULARIO CAIDA -->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formDowton');
                ?>
                <!-- INICIO FORMULARIO CAIDA -->
<?php ENDIF; ?>
