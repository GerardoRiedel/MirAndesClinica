...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
                ...
                <div class='widget-title'>
                    ...
                    <?php $attributes = array('id' => 'form');
                        echo form_open('clinica_enfermeria/tecs/FiltroListarDevolucion',$attributes);
                    ?>
                    <br>
                    <div class="col-lg-2">
    ...
    <div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
                ...
                <div class='col-lg-3' style=" text-align: right; background-color: #a15ebe; color: #ffffff;letter-spacing: 2px;box-shadow: 10px 10px 20px -10px rgba(0,0,0,0.75); border-radius: 4px; " >
                        <!--
                        <h6>Opciones de Tabla</h6>
                        -->
                        <span class='icon'>
                            <form id="form1" name="form1" method="post" action="<?php echo base_url("clinica_enfermeria/devoluciones/CarroListarDevolucion/" )?>">
...
<script>
    $("#btnExport").click(function(e) {
        ...
        tmpElemento.download = 'Sesiones T.E.C.xls';
            ...
            success: function(datos){
                ...
                var cantT = '';
                    ...
                    Highcharts.chart('container', {
                        title: {
                            text: 'Cantidad de Registros TEC Mensuales',
                            x: -20 //center
                        },
                        subtitle: {
                            text: 'Por Mes',
