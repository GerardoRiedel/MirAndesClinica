            ...
            <?php echo form_close();?>
                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                    ...
                    <tr>
                        ...
                        <!--
                        <td align="center">
                            <a class="tip-bottom" title="Modificar registro" href="<?php echo base_url("clinica_enfermeria/tecs/cargarModificarTec/" . $ses->tecSesId )?>"><i class="fas fa-edit" aria-hidden="true"></i></a>&nbsp;&nbsp;
                        </td>
                        -->
                    </tr>
                    <?php } ?>
