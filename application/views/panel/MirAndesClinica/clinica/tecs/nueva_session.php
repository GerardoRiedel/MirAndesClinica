    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
        <br><div class="col-lg-12" align="center">
            ...
            <?php $attributes = array('id' => 'form');
                echo form_open('clinica_enfermeria/tecs/guardarSession',$attributes);
            ?>
            ...
            <?php echo form_close();?>
                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a class="tip-bottom" title="Cargar Insumos" href="<?php echo base_url("clinica_enfermeria/tecs/cargarInsumos/".$ses->tecSesTecId.'_'.$ses->tecSesId)?>"><i class="fa fa-plus-square" aria-hidden="true"></i></a>&nbsp;&nbsp;
                        </td>
                        <!--
                        <td align="center">
                            <a class="tip-bottom" title="Modificar registro" href="<?php echo base_url("clinica_enfermeria/tecs/cargarModificarTec/" . $ses->tecSesId )?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;
                        </td>
                        -->
                    </tr>
                    <?php } ?>
