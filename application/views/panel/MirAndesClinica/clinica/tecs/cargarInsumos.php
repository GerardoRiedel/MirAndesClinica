...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                ...
                <?php $attributes = array('id' => 'form2');
                    echo form_open('clinica_enfermeria/tecs/guardarInsumos',$attributes);
                ?>
                <div class="col-lg-12">
                    ...
                    <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <td align="center">
                                        <a class="tip-bottom" title="Eliminar Registro" style="color:red"  href="<?php echo base_url("clinica_enfermeria/tecs/eliminarInsumo/".$item->inaTec.'_'.$item->inaSes.'_'.$item->inaId )?>">
