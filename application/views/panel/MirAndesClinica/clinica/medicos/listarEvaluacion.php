...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
            ...
            <div class='col-lg-8'>
                <?php 
                    IF(!empty($con->enfHabitos)){$habitos = explode('_', $con->enfHabitos);}
            ...
            <div class="col-lg-8">
                <?php 
                    IF(!empty($con->enfEliminacion)){$eli = explode('_',$con->enfEliminacion);}
                    echo '<b>INTESTINAL:</b> ';
            ...
            <div class="col-lg-8">
                <?php
                    IF(!empty($con->enfPsiquiatrico))$spi = explode('_',$con->enfPsiquiatrico);
            ...
            <div class="col-lg-8">
                <?php
                    IF(!empty($con->enfApariencia))$exa = $con->enfApariencia;
                    echo '<b>APARIENCIA:</b> ';
                    ...
                    ELSE echo '_';
                    IF(!empty($con->enfConciencia))$exa = $con->enfConciencia;
                    echo ' | <b>CONCIENCIA:</b> ';
                    IF($exa==='1')echo 'Vigil'; 
                    ...
                    ELSE echo '_';
                    IF(!empty($con->enfActitud))$exa = $con->enfActitud;
                    echo ' | <b>ACTITUD:</b> ';
                    ...
                    ELSE echo '_';
                    IF(!empty($con->enfConducta))$exa = $con->enfConducta;
                    echo ' | <b>CONDUCTA:</b> ';
            ...
            <div class="col-lg-8">
                <?php
                    IF(!empty($con->enfCognitiva))$cog = explode('_',$con->enfCognitiva);
                    ...
                    IF(!empty($con->enfAfectividad))$cog = $con->enfAfectividad;
                        IF(!empty($cog)){
                    ...
                    IF(!empty($con->enfAnimo))$cog = $con->enfAnimo;
                        IF(!empty($cog)){
                        echo ' | <b>ANIMO:</b> ';
                    ...
                    IF(!empty($con->enfLenguaje))$cog = $con->enfLenguaje;
                    IF(!empty($cog)){
                        echo ' | <b>LENGUAJE:</b> ';
            ...
            <div class="col-lg-8">
                <?php
                    IF(!empty($con->enfEstPensamiento))$pen = explode('_',$con->enfEstPensamiento);
                    //die($pen[1]);
                    ...
                    IF(!empty($con->enfJuicio))$pen = $con->enfJuicio;
                        IF(!empty($pen)){
                        echo ' | <b>JUICIO:</b> ';
