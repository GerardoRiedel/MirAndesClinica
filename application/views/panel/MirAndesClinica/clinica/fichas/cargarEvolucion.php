...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
            ...
            <!-- DATOS DE CLINICOS-->  
                    ...
                    <?php $vitales = explode('_', $enfermeriaIngreso->enfVitales); //die(var_dump($vitales));?>
                    <div class="col-lg-3">
                        <input name="evoPeso" id="peso" type="text" value="<?php IF(!empty($evo->evoPeso))echo $evo->evoPeso; ELSEIF(!empty($vitales[6]))echo $vitales[6];?>">
                    </div>
                    <div class="col-lg-2" align="right">
                    ...
                    <div class="col-lg-4">
                        <?php //die(var_dump($suicidio));
                            ...
                            ELSE $suicidio = 0;
                        ?>
                        <input type="text" readonly value="<?php IF($suicidio >= '6')echo 'ALTO'; ELSEIF($suicidio >= '1')echo 'BAJO'; ?>">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input name="evoTalla" id="talla" type="text" value="<?php IF(!empty($vitales[5]))echo $vitales[5]; ELSEIF(!empty($evo->evoTalla))echo $evo->evoTalla;?>">
                    </div>
                    <div class="col-lg-2" align="right">
                    ...
                    <div class="col-lg-4">
                        ...
                        ?>
                        <input type="text" readonly value="<?php IF($caida >= '3')echo 'ALTO'; ELSEIF($caida >= '1')echo 'BAJO';?>">
                    ...
                    <div class="col-lg-12" align="center">
                        <?php IF($this->session->userdata('perfil') !== '4'){ $this->load->view('panel/MirAndesClinica/clinica/ingresos/tablas/formCSV');}?>
                    </div>
                    <!--
                    <div class="col-lg-12"><br></div>
                    ...
                    <div class="col-lg-12"><br></div>
                     <div class="col-lg-4">
                        <label>EXAMENES Y PENDIENTES</label><br><textarea name="evoPendientes" id="evoPlan"><?php IF(!empty($evo->evoPendientes))echo $evo->evoPendientes; ELSEIF(!empty($evoAntigua->evoPendientes)) echo $evoAntigua->evoPendientes; ?></textarea>
                    </div>
                    
                    <?php $aseo = explode('_', $evo->evoAseo); ?>
                    <div class="col-lg-2" style="margin-top:50px">
                        <label>Aseo y Confort Día</label><br><br><label>Aseo y Confort Noche</label>
                    </div>
                    <div class="col-lg-2" style="margin-top:40px">
                        <input type="text" name="evoAseoDia" value="<?php echo $aseo[0]; ?>"><br><br><input type="text" name="evoAseoNoche" value="<?php echo $aseo[1]; ?>">
                    </div>
