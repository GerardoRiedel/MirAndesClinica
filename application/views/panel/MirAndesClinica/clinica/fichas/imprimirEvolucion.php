...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
        ...
        <div style="margin-left:50px">
                ...
                <div align="center" style="margin-top: -55px"><h3>HOJA DE ENFERMERIA MIRANDES CLINICA</h3></div>
                    ...
                    <div style="width:94%;margin-left:30px">
                    ...
                    <div align="center">
                        <table style="width:94%">
                            <tr>
                                <td class="td1" colspan="2"><label>Antecedentes Morbidos: </label><?php IF(!empty($ingEnfermeria->enfMorbidos))echo $ingEnfermeria->enfMorbidos;ELSE echo '...............'?></td>
                            </tr>
                            <tr>
                                ...
                                <td class="td1"><label>Escala Riesgo:   </label>
                                    <?php 
                                        ...
                                        IF($suicidio >= '6')echo 'ALTO'; ELSEIF($suicidio >= '1')echo 'BAJO'; ELSE echo '.........';
                                    ?>
                                </td>
                                <td class="td1"><label>Escala Dowton:   </label>
                                    <?php //die(var_dump($suicidio));
                                        IF(empty($caida))$caida = 0;
                                        IF($caida >= '3')echo 'ALTO'; ELSEIF($caida >= '1')echo 'BAJO'; ELSE echo '.........';
                                    ?>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div align="center">
                        <?php
                        $this->load->view('panel/MirAndesClinica/clinica/ingresos/tablas/formCSVImprimir');
                        ?>
                        <br>
                    </div>
                    ...
                    <div align="right" style="margin-top:0px">1/4</div>
                    <div style="transform: rotate(-90deg);top:-360px;left:510px;position: relative;width:700px;">
                    ...
                    <div>
                        <table style="width:94%">
                            <tr>
                                ...
                                <td class="td6"><label>PROCEDIMIENTOS: </label><?php echo $evo->evoExamenes;?></td>
                        ...
                        <br><br>
                    <div align="center">
                        <?php $aseo = explode('_', $evo->evoAseo); ?>
                        <table style="width:94%">
                            <tr>
                                <td rowspan="2" align="center" style="border:1px solid black;width:200px;;font-size: 13px"><b>Aseo<br>y<br>Confort</b></td>
                                <td style="border:1px solid black;width:320px;font-size: 13px" align="center"><b>Turno Día</b></td>
                                <td style="border:1px solid black;width:320px;font-size: 13px" align="center"><b>Turno Noche</b></td>
                            </tr>
                            <tr>
                                <td style="border:1px solid black;height: 200px"><?php echo $aseo[0]; ?></td>
                                <td style="border:1px solid black"><?php echo $aseo[1]; ?></td>
                            </tr>
                        </table>
                    </div>
                        <br><br>
                    ...
                    <?php $evolucion = explode('_',$evo->evoHoras); ?>
                        <table style="width:94%">
                            <tr>
                                <td><label>INGRESO Y EVOLUCIÓN ENFERMERIA</label></td>
                            </tr>
                            <tr>
                                <td><textarea class="textArea2" style="width:100% !important; height:500px"><?php IF(!empty( $evoEnfermeria->evoEnfDescripcion))echo $evoEnfermeria->evoEnfDescripcion; ?></textarea></td>
                                
                            </tr>
                        </table>
                             <div align="right" style="margin-top:0px">2/4</div>
                    <div style="transform: rotate(-90deg);top:-180px;left:425px;position: relative;width:700px;">
                        <span style=" font-size: 9px;opacity: 0.6">
                            PACIENTE: <label><?php echo strtoupper($datos->nombres).' '.strtoupper($datos->apellidoPaterno).' '.strtoupper($datos->apellidoMaterno);?></label> &nbsp;&nbsp;
                            RUT: <label><?php echo formatearRut($datos->rut);?></label> &nbsp;&nbsp;
                            FICHA: <label> <?php echo $datos->ficha; ?></label>
                    ...
                    <div>
                        <br><br><br>
                        <h4>INDICACIÓN DE MEDICAMENTOS DIARIOS</h4>
                    </div>
                    <div align="center">
                        <?php
                        $this->load->view('panel/MirAndesClinica/clinica/ingresos/tablas/formMedicamentosImprimir');
                        ?>
                    </div>
                    ...
                    <div align="right" style="margin-top:-30px">3/4</div>
                    ...
                    <table  style="width:94%">
                            ...
                            <tr>
                                ...
                                -->
                                <td>
                                   <label>EVOLUCIÓN TENS DÍA</label></td>
                            </tr>
                            <tr>
                                <!--
                                <td class="td7">
                                ...
                                -->
                                <td><textarea style=" height: 500px; width:100% !important"><?php echo $evo->evoDia;?></textarea></td>
                            </tr>
                            <tr><td style="border:none"><br></td></tr>
                            <tr>
                                <!--
                                <td><label>HORA</label></td>
                                -->
                                <td><label>EVOLUCIÓN TENS NOCHE</label></td>
                            </tr>
                            <tr>
                                <!--
                                <td class="td7">
                                ...
                                -->
                                <td><textarea style=" height: 500px; width:100% !important"><?php echo $evo->evoNoche;?></textarea></td>
                            </tr>
                    </table>
                    ...
                    <div align="right" style="margin-top:-27px">4/4</div>
...
<script type="text/javascript">
    ...
    function Popup(data) 
    {
        ...
        mywindow.document.write('<style>\n\
            ...
            .textArea2{height: 190px;width: 95%;line-height: 20px}\n\
