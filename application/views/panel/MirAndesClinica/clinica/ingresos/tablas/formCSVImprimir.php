<table align="center" style="width:94%">
     <!--------- SIGNOS VITALES ---------------->
    <tr>
        <?php $CSV0 = explode('_',$evo->evoCSV0); ?><?php $Ali0 = explode('_',$evo->evoAli0); ?>
        <?php $CSV1 = explode('_',$evo->evoCSV1); ?><?php $Ali1 = explode('_',$evo->evoAli1); ?>
        
        <td rowspan="7" style="border:1px solid black;width:100px;font-size: 13px" align="center"><b>SIGNOS<br>VITALES</b></td>
        <td style="border:1px solid black">HORA</td>
        <td style="border:1px solid black; width: 30px"><?php IF($CSV0[0]!=='00:00:00')echo $CSV0[0];?></td>
    ...
    <tr>
        ...
        <td style="border:1px solid black"><?php echo $CSV0[1];?></td>
    ...
    <tr>
        <td style="border:1px solid black">PULSO</td>
        <td style="border:1px solid black"><?php echo $CSV0[2];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <tr>
        <td style="border:1px solid black">FREC. RESP</td>
        <td style="border:1px solid black"><?php echo $CSV0[3];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
     ...
     <tr>
        <td style="border:1px solid black">PRES. ART</td>
        <td style="border:1px solid black"><?php echo $CSV0[4];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <tr>
        <td style="border:1px solid black">FI 02</td>
        <td style="border:1px solid black"><?php echo $CSV0[5];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <tr>
        <td style="border:1px solid black">SAT 02</td>
        <td style="border:1px solid black"><?php echo $CSV0[6];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <!--------- EGRESOS ---------------->
     <tr>
         <td rowspan="3" style="border:1px solid black;font-size: 13px"  align="center"><b>EGRESOS</b></td>
        <td style="border:1px solid black">DIURESIS</td>
        <td style="border:1px solid black"><?php echo $CSV0[7];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <tr>
        <td style="border:1px solid black">DEPOSICION</td>
        <td style="border:1px solid black"><?php echo $CSV0[8];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <tr>
        <td style="border:1px solid black">VOMITOS</td>
        <td style="border:1px solid black"><?php echo $CSV0[9];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <!--------- ALIMENTACION ---------------->
    <tr>
        <td rowspan="7" style="border:1px solid black;font-size: 13px" align="center"><b>ALIMENTACIÓN</b></td>
        <td style="border:1px solid black">TIPO</td>
        <td style="border:1px solid black"><?php echo $Ali0[0];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <tr>
        ...
        <td style="border:1px solid black"><?php echo $Ali0[1];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <tr>
        ...
        <td style="border:1px solid black"><?php echo $Ali0[2];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <tr>
        <td style="border:1px solid black">CANT. INDIC</td>
        <td style="border:1px solid black"><?php echo $Ali0[3];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
     ...
     <tr>
        <td style="border:1px solid black">CANT. REC</td>
        <td style="border:1px solid black"><?php echo $Ali0[4];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <tr>
        <td style="border:1px solid black">MEDICION R</td>
        <td style="border:1px solid black"><?php echo $Ali0[5];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
    ...
    <tr>
        <td style="border:1px solid black">HIDRATACIÓN</td>
        <td style="border:1px solid black"><?php echo $Ali0[6];?></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
        <td style="border:1px solid black"></td>
     ...
     <!--------- EXAMENES PENDIENTES ---------------->
    <tr>
        <td rowspan="4" style="border:1px solid black;font-size: 13px" align="center"><b>EXAMENES<br>PENDIENTES</b></td>
        <td style="border:1px solid black; height: 400px; vertical-align: text-top" colspan="14" align=" justify"><?php IF(!empty($evo->evoPendientes)) echo $evo->evoPendientes ?></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td style="border:1px solid black"><input type="text" class="cuerpo" name="evoCSV04" value="<?php echo $CSV0[4];?>">sat</td>
