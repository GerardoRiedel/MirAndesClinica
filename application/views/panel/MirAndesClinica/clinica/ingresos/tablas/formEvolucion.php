...
<br>
    ...
    -->
                <div class="col-lg-12" align="left" >
                        <label>EVOLUCIÓN DIARIA DE ENFERMERÍA</label>
                        <br><textarea name="evoEnfDescripcion" <?php IF($this->session->userdata('perfil') !== '4') echo 'readonly';?> style="height: 210px;width: 100%;line-height: 25px" placeholder="Ingrese aquí la evolución de Enfermería"><?php IF(!empty( $evoEnfermeria->evoEnfDescripcion))echo $evoEnfermeria->evoEnfDescripcion; ?></textarea>
                    </div>
    <div class="col-lg-12"><br><hr><br></div>
    
    <?php IF($this->session->userdata('perfil') !== '4') { ?>
                    <div class="col-lg-12" align="left" >
                        <label>EVOLUCIÓN TENS DÍA</label>
    ...
    -->
                    <div class="col-lg-12" align="left" >
                        <label>EVOLUCIÓN TENS NOCHE</label>
