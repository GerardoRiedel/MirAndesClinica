...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
        ...
        <?php $attributes = array('id' => 'form');
                ...
                echo form_open('clinica_enfermeria/ingresos/guardarNuevoIngresoEnfermeria',$attributes);
            ?>
...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                ...
                <div id="imprimir">
                <div class="col-lg-12" align="center"><h2 class="titulo">EVALUACIÓN  DE INGRESO ENFERMERÍA</h2></div>
                ...
                <div class="col-lg-12" ><hr style="height: 2px"></div>  
                    ...
                    <div class="col-lg-12">
                    <label class="titulo">EXAMEN FISICO</label>
                    </div>
                     <?php
                        
                        $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/enfermeria/formExamenMental_0_formulario');
                        ?>
                  <br>
                  ...
                  <br>
                    <div class="col-lg-12">
                        <label class="titulo" style="margin-left:13px">VALORIZACIÓN EXAMEN MENTAL</label>
                    </div>
                    <div class="col-lg-12" align="center">
                     <?php   
                        ...
                        //$this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/enfermeria/formExamenMental_2_formulario');
                     ?>
                    </div>
                  <br><br>
                    <div class="col-lg-12">
                    <label class="titulo">CUIDADOS DE ENFERMERÍA INMEDIATOS</label>
                    </div>
                    <div class="col-lg-12" align="center">
                        <?php
                    ...
                    <div class="col-lg-6">
                        <a href="<?php echo base_url("clinica_enfermeria/impresiones/cargarImprimir/".$datos->id )?>" >
