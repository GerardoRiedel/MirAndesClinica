...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
        ...
        <?php $attributes = array('id' => 'form');
            //die(var_dump($datos));
                echo form_open('clinica_enfermeria/ingresos/guardarEvolucionEnfermeria',$attributes);
            ?>
...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                ...
                <input type="hidden" value="<?php echo $datos->id;?>" name="fichaElectro" id="registro">
            ...
            <!-- DATOS DE CLINICOS-->
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" name="evoVisitasText"  value="<?php IF(!empty($evo->evoVisitasText))echo $evo->evoVisitasText; ?>" >
                    </div>
                    <div class="col-lg-12"></div>
                    <!--
          <div class="col-lg-2">
          ...
          -->
                    <div class="col-lg-2"><label>Teléfono</label></div>
                    <div class="col-lg-3">
                        ...
                        <input type="text" name="evoTelefonoText" value="<?php IF(!empty($evo->evoTelefonoText))echo $evo->evoTelefonoText; ?>" >
                    </div>
                    <div class="col-lg-12"></div>
          <!--
                    <div class="col-lg-2" >
          ...
          -->
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" name="evoSalidasText" value="<?php IF(!empty($evo->evoSalidasText))echo $evo->evoSalidasText; ?>" >
                    </div>
                    <div class="col-lg-12"></div>
          <!--
                    <div class="col-lg-2">
          ...
          -->
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" name="evoCuidadorText" value="<?php IF(!empty($evo->evoCuidadorText))echo $evo->evoCuidadorText; ?>" >
                    </div>
                    <div class="col-lg-12"></div>
                    ...
                    <div class='col-lg-12'><br></div>
                    <div class="col-lg-12">
                        <label>EVOLUCIÓN DE ENFERMERIA</label><br><textarea name="evoPlan" id="evoPlan"><?php echo $evo->evoPlan;?></textarea>
                    </div>
                    <!--
                    <div class="col-lg-4">
