                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a class="tip-bottom" title="Nuevo Registro" href="<?php echo base_url("clinica_enfermeria/ingresos/cargarNuevoRegistro/" . $item->id )?>"><i class="fa fa-sun-o" aria-hidden="true"></i></a>
                                </td>
                                <?php IF($this->session->userdata('perfil') === '4'):;?>
                                    <td align="center">
                                        <a class="tip-bottom" title="Nuevo Registro" href="<?php echo base_url("clinica_enfermeria/ingresos/cargarNuevoIngresoEnfermeria/" . $item->id )?>"><i class="fa fa-user-md" aria-hidden="true"></i></a>
                                    </td>
                                <?php ENDIF;?>
                                    <td align="center">
