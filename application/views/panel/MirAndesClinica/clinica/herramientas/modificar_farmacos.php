...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container"   >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_enfermeria/herramientas/guardarModificarFarmaco',$attributes);
            ?>
                            
            <div class='widget-content'>
                
                <br>
                        <input type="hidden" value="<?php IF(!empty($datos->idfarmaco))echo $datos->idfarmaco;?>" name="idfarmaco">
                
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                    
            <!-- DATOS DE PERSONALES-->               
                    <div class="col-lg-12" style=" margin-bottom: 10px">
                    <label class="titulo">Datos de Fármaco</label>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class='col-lg-5'>
                        <input name="descripcion" style=" width: 90%" type="text" required value="<?php IF(!empty($datos->descripcion))echo $datos->descripcion; ?>">
                    </div> 
            <div class="col-lg-12"><br></div>
                    <div class="col-lg-3">
                        <label>Valor del Fármaco</label>
                    </div>
                    
                    <div class='col-lg-5'>
                        <input name="valor" style=" width: 90%" type="text" required value="<?php IF(!empty($datos->farmValor))echo $datos->farmValor; ?>">
                    </div> 
