...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_enfermeria/herramientas/guardarModificarRegimen',$attributes);
            ?>
                            
            <div class='widget-content'>
                
                <br>
                        <input type="hidden" value="<?php IF(!empty($datos->regId))echo $datos->regId;?>" name="regId">
                
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                    
            <!-- DATOS DE PERSONALES-->               
                    <div class="col-lg-12" style=" margin-bottom: 10px">
                    <label class="titulo">Datos de Régimen</label>
                    </div>
                    <div class="col-lg-3">
                        <label>Nombre</label>
                    </div>
                    <div class='col-lg-4'>
                        <input name="regNombre" type="text" required value="<?php IF(!empty($datos->regNombre))echo $datos->regNombre; ?>">
                    </div>
                    ...
                    <div class='col-lg-4'>
                        <input name="regDescripcion" type="text" required value="<?php IF(!empty($datos->regDescripcion))echo $datos->regDescripcion; ?>">
                    </div> 
