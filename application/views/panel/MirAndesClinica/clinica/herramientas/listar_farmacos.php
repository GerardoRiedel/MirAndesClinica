                ...
                <table class='table table-bordered table-hover table-striped'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a class="tip-bottom" title="Modificar parámetro" href="<?php echo base_url("clinica_enfermeria/herramientas/cargar_farmacos/".$item->idfarmaco )?>"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                                <?php endforeach; ?>
                        </tbody>
