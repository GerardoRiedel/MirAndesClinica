    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
                ...
                <a href="<?php echo base_url("clinica_enfermeria/herramientas/cargar_examenes/")?>" style="color: #da812e; font-size: 30px; padding-top: -30px;margin-top:-30px;margin-bottom: 5px;margin-left: 25px" title="Agregar Examen"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $item->exaId; ?></td>
                                <td><?php IF(!empty($item->exaCodigo) && $item->exaCodigo !== '0')echo $item->exaCodigo; ?></td>
                                <td><?php echo STRTOUPPER($item->exaNombre); ?></td>
                                <td><?php IF(!empty($item->exaValor))echo '$ '.$item->exaValor; ?></td>
                                <td align="center"><?php IF($item->exaEstado === '1')echo 'Activo';ELSE 'Desactivo' ?></td>
                                <td align="center">
                                    <a class="tip-bottom" title="Modificar Examen" href="<?php echo base_url("clinica_enfermeria/herramientas/cargar_examenes/".$item->exaId )?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                                <?php endforeach; ?>
                        </tbody>
