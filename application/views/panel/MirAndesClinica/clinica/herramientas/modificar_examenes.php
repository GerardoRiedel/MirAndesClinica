...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            ...
            //die(var_dump($datos));
                echo form_open('clinica_enfermeria/herramientas/guardarModificarExamenes',$attributes);
            ?>
                            
            <div class='widget-content'>
                
                <br>
                        <input type="hidden" value="<?php IF(!empty($datos->exaId))echo $datos->exaId;?>" name="exaId">
                
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                    
            <!-- DATOS DE PERSONALES-->               
                    <div class="col-lg-12" style=" margin-bottom: 10px">
                    <label class="titulo">Datos de Examen</label>
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class='col-lg-4'>
                        <input name="exaNombre" style=" width: 90%" type="text" required value="<?php IF(!empty($datos->exaNombre))echo $datos->exaNombre; ?>">
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class='col-lg-4'>
                        <input name="exaValor" style=" width: 90%" type="text" required value="<?php IF(!empty($datos->exaValor))echo $datos->exaValor; ?>">
                    </div>
                    ...
                    <div class='col-lg-4'>
                        <input name="exaCodigo" style=" width: 90%" type="text" required value="<?php IF(!empty($datos->exaCodigo))echo $datos->exaCodigo; ?>">
                    </div>
