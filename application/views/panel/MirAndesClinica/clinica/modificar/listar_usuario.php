                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style=" color :<?php echo $color ?>" align="center">
                                    ...
                                    <a class="tip-bottom" title="Modificar usuario" href="<?php echo base_url("clinica_enfermeria/modificar/cargar_usuario/".$item->uspId )?>"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                    <?php ENDIF; ?>
                                </td>
                            </tr>
                                <?php endforeach; ?>
