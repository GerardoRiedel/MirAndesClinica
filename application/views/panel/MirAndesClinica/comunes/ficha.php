            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" >
                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="center"><?php IF(!empty($item->ficha))echo $item->ficha; ELSEIF(!empty($item->tecFicha)) echo '0'.$item->tecFicha.' - Tec'; ?></td>
                                <td align="center">
                                ...
                                <?php IF($this->session->userdata('perfil') == '1' ||  $this->session->userdata('perfil') == '4' ||  $this->session->userdata('perfil') == '5' ){ ?>
                                    <td align="center">
                                        <a class="tip-bottom" title="Control Médico" href="<?php echo base_url("clinica_enfermeria/medicos/cargarNuevoControl/" . $item->id )?>"><i class="fa fa-stethoscope" aria-hidden="true"></i></a>
                                    </td>
                                <?php } ?>
                            </tr>
                                <?php endforeach; ?>
...
<!-- SESIONES TEC-->                            
 ...
 <hr />
                        <div class="row">
                            <div class="col-md-12">
                                <label style="font-size:18px">UGH</label>
                            </div>
                        </div>
<!-- HISTORIAL UGH-->
                        <div class="row">
    ...
    <table class='table table-bordered table-hover table-striped'>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo strtoupper($item->ctaNombre).' '.strtoupper($item->ctaApellido).' '.strtoupper($item->ctaApellidoM); ?></td>
                <td><?php IF(!empty($item->ctaRut)) echo formatearRut($item->ctaRut); ?></td>
                <td><?php echo $item->ctaEmail; ?></td>
                <td align="right"><?php echo $item->ctaNumero; ?></td>
                
                <td><?php echo $item->banNombre; ?></td>
                <td><?php echo $item->tipNombre; ?></td>
...
<script>
    $("#btnExport").click(function(e) {
        ...
        tmpElemento.download = 'Fichas.xls';
    ...
    function cargaModal(rut){
        ...
        $.ajax({
            ...
            //bloque de historial de ingresos(registros)
                ...
                var table = '<table class="table table-bordered table-striped table-hover data-table" style="font-size: 10px; width:100%;" > <thead> <tr> <th>Id</th><th>Fecha de Ingreso</th><th>Fecha de Alta</th><th>Antecedentes</th><th>Ver Controles Médicos</th><th>Evaluación de Ingreso</th><th>Ver Evolucion Diaria</th> </tr> </thead>';
                ...
                $.ajax({
                    ...
                    for(keyVar in datos) {
                        ...
                        if(datos[keyVar].id!=null) {
                            table += '<tr class= "gradeX"><td  align="center">' + datos[keyVar].id + '</td><td  align="center">'+datos[keyVar].fechaIngreso+'</td><td  align="center">'+datos[keyVar].fechaSalidaReal+'</td>\n\
                        <td  align="center"><a href="http://www.cetep.cl/mirandes/index.php/<?php echo $vista;?>/impresiones/cargarImprimir/'+datos[keyVar].id+'"><i class="fa fa-print" aria-hidden="true"></i></a></td>\n\
                        <td  align="center"><a href="http://www.cetep.cl/mirandes/index.php/<?php echo $vista;?>/medicos/listarControles/'+datos[keyVar].id+'"><i class="fa fa-eye" aria-hidden="true"></i></a></td>\n\
                        <td  align="center"><a href="http://www.cetep.cl/mirandes/index.php/<?php echo $vista;?>/medicos/listarEvaluacion/'+datos[keyVar].id+'"><i class="fa fa-eye" aria-hidden="true"></i></a></td>\n\
                        <td  align="center"><a href="http://www.cetep.cl/mirandes/index.php/<?php echo $vista;?>/medicos/listarEvoluciones/'+datos[keyVar].id+'"><i class="fa fa-eye" aria-hidden="true"></i></a></td></tr>';
                        }
                    }
