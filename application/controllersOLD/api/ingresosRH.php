 ...
 * Time: 14:00
 */
class IngresosRH extends CI_Controller
{
    ...
    public function guardar($array){
        ...
        ELSE $rutTitular = '0';
                ...
                if(!empty($alergia)){
                    ...
                    $ficha = $this->hd_model->dameRHFicha($paciente->id);
                    }

                    $idFichaHoy = $this->hd_model->dameIdFichaRHHoy($paciente->id);
                    ...
                    $idFicha = $this->hd_model->dameIdFichaRH($paciente->id);
