...
class Modificar extends CI_Controller {
    ...
    public function listar_paciente()
    {
        ...
        Layout_Helper::cargaVista($this,'listar_paciente',$data,'clinica');   
    }
    ...
    public function cargar_paciente($id)
    {
        ...
        $data['menu']       = "mantenedores";
        $data['submenu']    = "pmantenedor";
        Layout_Helper::cargaVista($this,'modificar_paciente',$data,'clinica');   
    }
    ...
    public function listar_apoderado()
    {
        ...
        Layout_Helper::cargaVista($this,'listar_apoderado',$data,'clinica');   
    }
    ...
    public function cargar_apoderado($id)
    {
        ...
        $data['menu']       = "mantenedores";
        $data['submenu']    = "amantenedor";
        Layout_Helper::cargaVista($this,'modificar_apoderado',$data,'clinica');   
    }
    public function listar_usuarios()
    {
        ...
        Layout_Helper::cargaVista($this,'listar_usuario',$data,'clinica');   
    }
    public function cargar_usuario($id='')
    {
        ...
        $data['menu']       = "mantenedores";
        $data['submenu']    = "umantenedor";
        Layout_Helper::cargaVista($this,'modificar_usuario',$data,'clinica');   
    }
