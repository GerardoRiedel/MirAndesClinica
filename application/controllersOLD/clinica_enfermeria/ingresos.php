...
class Ingresos extends CI_Controller {
    ...
    {//EVOLUCION
        ...
        $data['medicamento']= $this->enfermeria_model->dameTodosAdminEvolucion($id);
        $data['horasMed']   = $this->enfermeria_model->dameTodosAdminHoras($id);
        $data['farmaMed']   = $this->enfermeria_model->dameTodosAdminFarmacos($id);
        //die(var_dump($data['medicamento']));
        $data['evo']        = $this->evoluciones_model->dameUno($id);
        ...
        $data['menu']       = "ingreso";
        $data['submenu']    = "lingreso";
        Layout_Helper::cargaVista($this,'cargarNuevoRegistro',$data,'clinica');   
    }
