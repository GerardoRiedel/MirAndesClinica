...
class Herramientas extends CI_Controller {
    ...
    public function listar_farmacos()
    {
        ...
        Layout_Helper::cargaVista($this,'listar_farmacos',$data,'clinica');   
    }
    public function cargar_farmacos($id='')
    {
        ...
        $data['menu']       = "herramientas";
        $data['submenu']    = "fherramientas";
        Layout_Helper::cargaVista($this,'modificar_farmacos',$data,'clinica');   
    }
    ...
    public function listar_regimen()
    {
        ...
        Layout_Helper::cargaVista($this,'listar_regimen',$data,'clinica');   
    }
    public function cargar_regimen($id='')
    {
        ...
        $data['menu']       = "herramientas";
        $data['submenu']    = "rherramientas";
        Layout_Helper::cargaVista($this,'modificar_regimen',$data,'clinica');   
    }
    ...
    public function listar_examenes()
    {
        ...
        Layout_Helper::cargaVista($this,'listar_examenes',$data,'clinica');   
    }
    public function cargar_examenes($id='')
    {
        ...
        $data['menu']       = "herramientas";
        $data['submenu']    = "eherramientas";
        Layout_Helper::cargaVista($this,'modificar_examenes',$data,'clinica');   
    }
    ...
    public function listar_insumos()
    {
        ...
        Layout_Helper::cargaVista($this,'listar_insumos',$data,'clinica');   
    }
    public function cargar_insumos($id='')
    {
        ...
        $data['menu']       = "herramientas";
        $data['submenu']    = "iherramientas";
        Layout_Helper::cargaVista($this,'modificar_insumos',$data,'clinica');   
    }
