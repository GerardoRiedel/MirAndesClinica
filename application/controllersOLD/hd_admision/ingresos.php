...
//INSTITUCION            
            ...
            $this->hd_model->diagnostico   = $this->input->post('diagnostico');
...
$mensaje = 'Buenos dias,
Para su conocimiento, se ha generado un nuevo ingreso HD con el identificador '.$idFicha->id.', ficha N '.$ficha.'. Para el paciente Id N '.$paciente->id.'.
