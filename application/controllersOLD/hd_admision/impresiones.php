...
class Impresiones extends CI_Controller {
  ...
  //
       ...
       // 
        ...
        {
            $opciones[0] = $opciones[1] = $opciones[3] = $opciones[5] = $opciones[6] = $opciones[7] = $opciones[8] = $opciones[10] = $opciones[11] = 'off';
            $data['signos'] = $this->hd_model->dameSignosId($id);
        }
        $opciones[2] = $this->input->post('formSignos');
        IF($this->input->post('formPrefactura')==='on')
        {
            $opciones[0] = $opciones[1] = $opciones[2] = $opciones[3] = $opciones[5] = $opciones[6] = $opciones[7] = $opciones[8] = $opciones[10] = 'off';
        }
    ...
    public function imprimirPrefactura($id)
    {
        ...
        $opciones[11]='on';
        $opciones[0] = $opciones[1] = $opciones[2] = $opciones[3 ]= $opciones[4] = $opciones[5] = $opciones[6] = $opciones[7] = $opciones[8] = $opciones[9] = $opciones[10] = $opciones[12] = 'off';
    ...
    public function imprimirEvaluacion($id)
    {
        ...
        $opciones[12]='on';
        $opciones[0] = $opciones[1] = $opciones[2] = $opciones[3 ]= $opciones[4] = $opciones[5] = $opciones[6] = $opciones[7] = $opciones[8] = $opciones[9] = $opciones[10] = $opciones[11] = 'off';
