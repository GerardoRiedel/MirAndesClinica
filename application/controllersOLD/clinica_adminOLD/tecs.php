...
Cetep';
    ...
    ////GUARDAR DATOS DE DEPOSITO  
        ...
        Layout_Helper::cargaVista($this,'imprimirTec',$data,'ingresos');   
    }
...
////GUARDAR CONTACTO     
     ...
     public function guardarInsumos()
    {
        ...
        IF(!empty($cantidad) && $exam[0]!=='0'){
           ...
           $id = $tecId.'_'.$id;  
        redirect(base_url().'clinica_admin/tecs/cargarInsumos/'.$id);
    ...
    public function eliminarInsumo($id)
    {
        ...
        $this->tecs_model->guardarInsumosAsignados();
        redirect(base_url().'clinica_admin/tecs/cargarInsumos/'.$id[0].'_'.$id[1]);
    }
