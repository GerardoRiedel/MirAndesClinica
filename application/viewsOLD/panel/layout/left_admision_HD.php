...
<li class="<?php if($menu === 'fichas')echo "active open" ?>">
    <a href="<?php echo base_url("hd_admision/fichas/listar_paciente"); ?>"><i class="fa fa-newspaper-o" aria-hidden="true" style=" width: 20px;text-align: center"></i>&nbsp;Fichas<i class="arrow fa fa-chevron-right"></i></a>
</li>
<!--TEC
