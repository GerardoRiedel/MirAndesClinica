    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
                ...
                <a href="<?php echo base_url("hd_admision/modificar/cargar_usuario/")?>" style="color: #da812e; font-size: 30px;margin-left: 25px" title="Agregar Usuario"><i class="fa fa-user-plus" aria-hidden="true"></i></a>
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style=" color :<?php echo $color ?>"><?php IF($item->uspPerfil === '11')echo 'Administrador';ELSEIF($item->uspPerfil === '12')echo 'Admisión';ELSEIF($item->uspPerfil === '13')echo 'Clínico';; ?></td>
                                <td style=" color :<?php echo $color ?>" align="center">
                                    <?php //IF($item->uspEstado === '1')echo 'Activo';ELSE echo 'Desactivo'; ?>
                                    
                                    <?php IF($this->session->userdata('perfil') === '11' && $item->uspEstado === '1') { ;?>
                                    <a class="tip-bottom" title="Desactivar usuario" style=" color: green; margin-bottom: 0px"  href="<?php echo base_url("hd_admision/modificar/desactivar_usuario/".$item->uspId )?>">Activo<!--<i class="fa fa-ban" aria-hidden="true"></i>--></a>
                                    
                                    <?php }ELSEIF($this->session->userdata('perfil') === '11' && $item->uspEstado === '2') { ;?>
                                    <a class="tip-bottom" title="Activar usuario" style=" color: red" href="<?php echo base_url("hd_admision/modificar/activar_usuario/".$item->uspId )?>">Desactivo<!--<i class="fa fa-check" aria-hidden="true"></i>--></a>
                                    <?php } ?>
