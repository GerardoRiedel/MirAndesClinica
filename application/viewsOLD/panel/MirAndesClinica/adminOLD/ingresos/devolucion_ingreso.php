...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25; background-color: #db8918">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            <?php $attributes = array('id' => 'form');
                echo form_open('clinica_admin/devoluciones/guardarFichaDevolucion',$attributes);
            ?>
...
<!--INICIO DEPOSITOS-->     
                    ...
                    <div class="col-lg-7"></div>
                    <div class="col-lg-5"><h6 style=" font-size: 10px">Recuerde que al seleccionar esta opción el <b>depósito NO se creará</b>, por lo que no sera visible dentro de la rendición</h6></div>
...
<!--INICIO DEVOLUCIONES-->
                    ...
                    <div class='col-lg-4'>
                        <input name="apePatDev"  type="text" minlength="4" required id="apePatDev">
                    </div> 
                    <div class="col-lg-2">
                        <label>Apellido Materno</label>
                    </div>
                    <div class='col-lg-4'>
                        <input name="apeMatDev"  type="text" minlength="4" required id="apeMatDev">
                    </div> 
...
<script>
    ...
    var tip = $('input:radio[name=deposito]:checked').val();
        if(tip === '2'){
            ...
            //if($("#serieCheque").val() === '0') {  
            //    $("#iconSerieCheque").show();
            //    //alert("Banco Requerido");  
            //    return false;
            //} 
            //if($("#ctaCheque").val() === '0') {  
