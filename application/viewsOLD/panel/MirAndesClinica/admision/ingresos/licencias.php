            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="center"><?php echo $item->licId; ?></td>
                                <td align="center"><?php echo $item->licDesde; ?></td>
                                <td align="center"><?php echo $item->licHasta;  ?></td>
                                <td align="center"><?php echo $item->licDias; ?></td>
                                <td><?php echo $item->licNumero; ?></td>
                                <td><?php IF(!empty($item->licRut))echo formatearRut($item->licRut) ?></td>
                                <td><?php echo strtoupper($item->licApePat).' '.strtoupper($item->licApeMat).' '.strtoupper($item->licNombre); ?></td>
                                <td align="center">
                                    <a class="tip-bottom" title="Agregar Nueva Licencia" href="<?php echo base_url("clinica_admision/ingresos/cargarLicencia/" . $item->licRut )?>"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                                <?php endforeach; ?>
                        </tbody>
