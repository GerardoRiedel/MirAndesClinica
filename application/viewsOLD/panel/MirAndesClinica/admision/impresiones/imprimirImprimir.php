...
<?php IF($opciones[8] === 'on'):?>
    <!-- INICIO FORMULARIO ESTADISTICO -->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formEstadistico');
                ?>
    <!-- FIN FORMULARIO ESTADISTICO -->
<?php ENDIF; ?>
                
<?php IF($opciones[0] === 'on'): ?>
    <!-- INICIO FORMULARIO DE URGENCIAS -->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formUrgencias');
                ?>
    <!-- FIN FORMULARIO DE URGENCIAS -->
<?php ENDIF; ?>
<?php IF($opciones[1] === 'on'): ?>
    <!-- INICIO FORMULARIO DE IDENTIFICACION PACIENTE APODERADO -->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formPacienteApoderado');
                ?>
    <!-- FIN FORMULARIO DE PACIENTE APODERADO -->
<?php ENDIF; ?>   
<?php IF($opciones[2] === 'on'): ?>
    <!-- INICIO FORMULARIO DE DEPOSITO -->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formDeposito');
                ?>
    <!-- FIN FORMULARIO DE DEPOSITO -->
<?php ENDIF; ?>
<?php IF($opciones[3] === 'on'): ?>
    <!-- INICIO FORMULARIO AUTORIZACION CETEP-->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formAutorizacionCetep');
                ?>
    <!-- FIN FORMULARIO AUTORIZACION CETEP-->
<?php ENDIF; ?>
<?php IF($opciones[4] === 'on'): ?>
    <!-- INICIO FORMULARIO AUTORIZACION CETEP (USUARIO/BENEFICIARIO)-->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formAutorizacionUsuarioBeneficiario');
                ?>
    <!-- FIN FORMULARIO AUTORIZACION CETEP (USUARIO/BENEFICIARIO)-->
<?php ENDIF; ?>
<?php IF($opciones[5] === 'on'): ?>
    <!-- INICIO FORMULARIO CUIDADOR-->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formCuidador');
                ?>
...
<?php IF($opciones[6] === 'on' && ($datos->esGes === 'Si' || $datos->ges === '1')): ?>
    ...
    <!-- GES -->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formConsentimientoGES');
                ?>
    <!-- GES -->
...
<?php IF($opciones[6] === 'on' && $datos->esGes !== 'Si' && $datos->ges !== '1'): ?>
                ...
                <!-- LIBRE ELECCION -->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formConsentimientoLIBRE');
                ?>
...
<?php IF($opciones[7] === 'on'):?>
                <!-- INICIO FORMULARIO ENFERMERIA -->
                <?php
                $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formEnfermeria');
                ?>
                <!-- INICIO FORMULARIO ENFERMERIA -->
<?php ENDIF; ?>
...
<?php IF($opciones[10] === 'on'):?>
            <!-- INICIO FORMULARIO ENFERMERIA -->
            <?php
            $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formTEC');
            ?>
            <!-- INICIO FORMULARIO ENFERMERIA -->
<?php ENDIF; ?>
<?php IF($opciones[11] === 'on'):?>
            <!-- INICIO FORMULARIO ENFERMERIA -->
            <?php
            $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formInsumos');
            ?>
            <!-- INICIO FORMULARIO ENFERMERIA -->
<?php ENDIF; ?>
...
<?php IF($opciones[12] === 'on'):?>
            <!-- INICIO FORMULARIO ENFERMERIA -->
            <?php
            $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formPrefactura');
            ?>
            <!-- INICIO FORMULARIO ENFERMERIA -->
<?php ENDIF; ?>
...
<?php IF($opciones[13] === 'on'):?>
            <!-- INICIO FORMULARIO ENFERMERIA -->
            <?php
            $this->load->view('panel/MirAndesClinica/admision/impresiones/formularios/formExamenes');
            ?>
            <!-- INICIO FORMULARIO ENFERMERIA -->
<?php ENDIF; ?>
