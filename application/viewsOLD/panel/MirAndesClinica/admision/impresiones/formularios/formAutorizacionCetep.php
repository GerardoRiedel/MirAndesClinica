...
<div style="page-break-after: always;">
                    ...
                    <div class="subir">
                        ...
                        <div class="col-lg-12" align="justify">
                            Yo, <label><?php echo $datos->nombres.' '.$datos->apellidoPaterno.' '.$datos->apellidoMaterno;?></label> Rut <label><?php echo formatearRut($datos->rut);?></label>, nacido/a el <label><?php echo $fecha;?></label>, domiciliado en <label><?php echo $datos->direccion;?></label> comuna de <label><?php echo $datos->comuna;?></label>
                            en mi calidad de paciente de CETEP ASOCIADOS SPA., en adelante CETEP, y de acuerdo con el artículo 3° de la ley N° 20.584, autorizo lo siguiente:
                            <br><br>
