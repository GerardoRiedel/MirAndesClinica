...
<div style="page-break-after: always;">
                ...
                <div class="col-lg-12" align="center">
                    <h3>CONSENTIMIENTO DE INGRESO MIRANDES CLÍNICA LIBRE ELECCIÓN</h3>
                </div>
                ...
                <div class="col-lg-12" align="justify">
                    Nombre Paciente: <?php echo strtoupper($datos->nombres).' '.strtoupper($datos->apellidoPaterno).' '.strtoupper($datos->apellidoMaterno);?> Rut: <?php echo formatearRut($datos->rut);?>
                    <br><br>
                    Nombre Apoderado/ Familiar Responsable: <?php echo strtoupper($apoNombre).' '.strtoupper($apoApePat).' '.strtoupper($apoApeMat); ?> Rut: <?php echo formatearRut($apoRut);?>
                    <br><br>
                    Médico Tratante: <?php IF(!empty($datos->nombresmedicoAsignado))echo strtoupper($datos->nombresmedicoAsignado).' '.strtoupper($datos->apellidomedicoAsignado);ELSE echo '.............................................................................'; ?> Rut: <?php IF(!empty($datos->rutmedico))echo formatearRut($datos->rutmedico); ELSE echo '...............................'?>
                    <br>
                    ...
                    1.<blockquote>Es  importante  que  usted  sepa  que,  si  el  ingreso  del  paciente  es  de  urgencia  o  libre  elección,  toda  la 
                    hospitalización  y  atención  por  el  médico  psiquiatra  será  cobrada  y  pagada  en  forma  particular  y/o  de 
                    acuerdo a su plan de salud.  El día cama de libre elección en Mirandes Clínica  es de $105.000.-  en habitación
                    compartida (2 camas), con baño compartido.</blockquote>
                    ...
                    18.<blockquote>La  Clínica  no  custodiará  dinero  ni  joyas  de  los  pacientes,  estos  serán  devueltos  al  familiar  responsable  o 
                    apoderado. La Clínica no se hará responsable de la pérdida de cualquiera de éstos que porte el paciente en 
                    sus pertenencias.
                    </blockquote>
                    ...
                    declarar por escrito en el libro de registro de pertenencias con el nombre y firma de quien retira.
                    </blockquote>
                    ...
                    procedimiento y se solicitará su autorización previo al tratamiento.
                    </blockquote>
                    33.<blockquote>En pacientes graves y/o de riesgo, el médico tratante puede dejar indicación de cuidadora 24 horas, esta  no 
                    podrá  ser  un  familiar  o  amigo(a)  del  paciente.  Sólo  se  permitirán  cuidadoras  con  experiencia  en  salud 
                    mental. 
                    </blockquote>
                    34.<blockquote>En  caso  de  <b>Urgencias  o  Emergencia  Médicas  No  Psiquiátricas,</b>  se  le  informará  al  familiar  responsable  o 
                    apoderado, y el paciente será trasladado en ambulancia al Servicio de Urgencia de la Clínica u Hospital que 
                    ellos hayan dejado <b>explicitado por escrito al ingreso del paciente. </b>
                    </blockquote>
                    35.<blockquote>El no cumplimiento de las normativas y deberes, la  agresión de cualquier tipo al personal o a otros pacientes 
                    ...
                    36.<blockquote>Excepcionalmente,    en caso de  un paciente grave o con alteración del juicio realidad,  o que por su situación 
                    ...
                    37.<blockquote>A su ingreso, si es por Libre elección, se requiere que el paciente o su acompañante deje en depósito una 
                    garantía de $200.000 en efectivo, o un cheque por la misma cantidad sin fecha. Dicha suma permitirá cubrir 
                    gastos  de  insumos  y/o  medicamentos  que  se  utilicen  dentro  de  la  hospitalización.  De  no  ser  utilizado  el 
                    depósito o lo que reste de él, un funcionario de la Clínica se contactará con la persona que lo entregó para 
                    coordinar la devolución del dinero, una vez que haya concluido la gestión administrativa que corresponda a 
                    esta hospitalización.  Además, al ingreso y cada 5 días de le solicitará un cheque o efectivo por la suma de 
                    $525.000.- correspondiente al día cama por esa cantidad de días.
                    </blockquote>
                    38.<blockquote>MirAndes Clínica se reserva el derecho de admitir  o no  pacientes que al momento de    su ingreso evidencien 
                    ...
                    <br><br>
                    NOMBRE DEL APODERADO DEL PACIENTE: <b><?php echo strtoupper($apoNombre).' '.strtoupper($apoApePat).' '.strtoupper($apoApeMat); ?></b>
                    <br><br>
                    C.I. N° <?php echo formatearRut($apoRut);?> &nbsp;&nbsp;&nbsp;&nbsp;FIRMA.............................
                    <br><br><br>
