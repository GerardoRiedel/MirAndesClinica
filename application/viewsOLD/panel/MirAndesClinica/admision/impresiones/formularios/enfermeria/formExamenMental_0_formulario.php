...
<div align="center">
    ...
    <div style=" display: inline-block">
        ...
        <div align="left"><?php //echo $enfermeria->enfAlcohol;?>
            <table>
                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Alergias</b>&nbsp;</td>  <td><input type='radio' name="alergiaR" <?php IF(!empty($datos->alergia))echo 'checked';?>> Si <input type='radio' name="alergiaR" <?php IF(empty($datos->alergia))echo 'checked';?>> No, <input type="text" placeholder="Cual" name="alergia" value="<?php IF(!empty($datos->alergia))echo $datos->alergia;?>"></td></tr>
                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Tabaco</b>&nbsp;</td>    <td><input type='radio' name="tabacoR" value="1" <?php IF(!empty($enfermeria->enfTabaco)&&$enfermeria->enfTabaco==='1')echo 'checked';?>> Si    <input type='radio' name="tabacoR" value="0" <?php IF(empty($enfermeria->enfTabaco)&&$enfermeria->enfTabaco==='0')echo 'checked';?>> No,    <input type="text" placeholder="Cantidad" name="tabaco" value="<?php IF(!empty($habitos[0]))echo $habitos[0];?>"></td></tr>
                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Alcohol</b>&nbsp;</td>   <td><input type='radio' name="alcoholR" value="1" <?php IF(!empty($enfermeria->enfAlcohol)&&$enfermeria->enfAlcohol==='1')echo 'checked';?>> Si <input type='radio' name="alcoholR" value="0" <?php IF(empty($enfermeria->enfAlcohol)&&$enfermeria->enfAlcohol==='0')echo 'checked';?>> No, <input type="text" placeholder="Cantidad" name="alcohol" value="<?php IF(!empty($habitos[1]))echo $habitos[1];?>"></td></tr>
                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Drogas</b>&nbsp;</td>    <td><input type='radio' name="drogasR" value="1" <?php IF(!empty($enfermeria->enfDrogas)&&$enfermeria->enfDrogas==='1')echo 'checked';?>> Si    <input type='radio' name="drogasR" value="0" <?php IF(empty($enfermeria->enfDrogas)&&$enfermeria->enfDrogas==='0')echo 'checked';?>> No,    <input type="text" placeholder="Cual" name="drogas" value="<?php IF(!empty($habitos[2]))echo $habitos[2];?>"></td></tr>
            </table>
        </div>
        <br>
        <div align="left">
