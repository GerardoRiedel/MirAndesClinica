...
<div class="col-lg-6" align="left">
    <div style=" display: inline-block">
        <table style="border:2px solid grey;">
            ...
            <tr><td>&nbsp;&nbsp;Somnolencia</td>        <td align="center"><input type="radio" name="somnoliencia" <?php IF($conciencia[0]==='1')echo 'checked';?> value="1"></td>          <td align="center"><input type="radio" name="somnoliencia" value="0" <?php IF($conciencia[0]==='0' || empty($conciencia[0]))echo 'checked';?>></td></tr>
            <tr><td>&nbsp;&nbsp;Confusión</td>          <td align="center"><input type="radio" name="confusion" <?php IF($conciencia[1]==='1')echo 'checked';?> value="1"></td>             <td align="center"><input type="radio" name="confusion" value="0" <?php IF($conciencia[1]==='0' || empty($conciencia[1]))echo 'checked';?>></td></tr>
            <tr><td>&nbsp;&nbsp;Hipervigilancia</td>    <td align="center"><input type="radio" name="hipervigilancia" <?php IF($conciencia[2]==='1')echo 'checked';?> value="1"></td>       <td align="center"><input type="radio" name="hipervigilancia" value="0" <?php IF($conciencia[2]==='0' || empty($conciencia[2]))echo 'checked';?>></td></tr>
            <tr><td>&nbsp;&nbsp;Delirium</td>           <td align="center"><input type="radio" name="delirium" <?php IF($conciencia[3]==='1')echo 'checked';?> value="1"></td>              <td align="center"><input type="radio" name="delirium" value="0" <?php IF($conciencia[3]==='0' || empty($conciencia[3]))echo 'checked';?>></td></tr>
            <tr><td>&nbsp;&nbsp;Estado crepuscular</td> <td align="center"><input type="radio" name="crepuscular" <?php IF($conciencia[4]==='1')echo 'checked';?> value="1"></td>           <td align="center"><input type="radio" name="crepuscular" value="0" <?php IF($conciencia[4]==='0' || empty($conciencia[4]))echo 'checked';?>></td></tr>
            <tr><td>&nbsp;&nbsp;Despersonalización</td> <td align="center"><input type="radio" name="despersonalizacion" <?php IF($conciencia[5]==='1')echo 'checked';?> value="1"></td>    <td align="center"><input type="radio" name="despersonalizacion" value="0" <?php IF($conciencia[5]==='0' || empty($conciencia[5]))echo 'checked';?>></td></tr>
            <tr><td>&nbsp;&nbsp;Desrealización</td>     <td align="center"><input type="radio" name="desrealizacion" <?php IF($conciencia[6]==='1')echo 'checked';?> value="1"></td>        <td align="center"><input type="radio" name="desrealizacion" value="0" <?php IF($conciencia[6]==='0' || empty($conciencia[6]))echo 'checked';?>></td></tr>
        </table>
    </div>
</div>
<div class="col-lg-6" align="left">
    ...
    <div style=" display: inline-block;" align="left">
        <table style="border:2px solid grey;">
            ...
            <tr><td>&nbsp;&nbsp;Espacio</td>            <td align="center"><input type="radio" name="espacio" <?php IF($orientacion[0]==='1')echo 'checked';?> value="1"></td>              <td align="center"><input type="radio" name="espacio" value="0" <?php IF($orientacion[0]==='0' || empty($orientacion[0]))echo 'checked';?>></td></tr>
            <tr><td>&nbsp;&nbsp;Tiempo</td>             <td align="center"><input type="radio" name="tiempo" <?php IF($orientacion[1]==='1')echo 'checked';?> value="1"></td>               <td align="center"><input type="radio" name="tiempo" value="0" <?php IF($orientacion[1]==='0' || empty($orientacion[1]))echo 'checked';?>></td></tr>
        </table>
...
<div class="col-lg-6" align="left">
    <div style=" display: inline-block">
        <table style="border:2px solid grey;">
            ...
            <tr><td colspan="4">&nbsp;&nbsp;Alucinaciones</td>  <td align="center"><input type="radio" name="alucinaciones" <?php IF($percepcion[0]==='1')echo 'checked';?> value="1"></td> <td align="center"><input type="radio" name="alucinaciones" value="0" <?php IF($percepcion[0]==='0' || empty($percepcion[0]))echo 'checked';?>></td></tr>
            <tr><td colspan="4">&nbsp;&nbsp;Iluciones</td>      <td align="center"><input type="radio" name="ilusiones" <?php IF($percepcion[1]==='1')echo 'checked';?> value="1"></td>     <td align="center"><input type="radio" name="ilusiones" value="0" <?php IF($percepcion[1]==='0' || empty($percepcion[1]))echo 'checked';?>></td></tr>
...
<div style=" display: inline-block;">
    <table style="border:2px solid grey;">
        <tr><td style="width:150px;border-bottom: 1px solid grey;" align="left" colspan="2"><b>5. Alteración del Juicio</b></td></tr>
        <tr><td align="right"><input type="radio" name="juicio" <?php IF($juicio[0]==='1')echo 'checked';?> value="1"><b> Si&nbsp;&nbsp;</b></td>      <td align="left">&nbsp;&nbsp;<input type="radio" name="juicio" <?php IF($juicio[0]==='0' || empty($juicio[0]))echo 'checked';?> value="0"><b> No</b></td></tr>
...
<div class="col-lg-12" align="left">
    <div style=" display: inline-block">
        <table style="border:2px solid grey;">
            <tr><td style="border-bottom: 1px solid grey;" colspan="9" align="left"><b>6. Alteraciones del Pensamiento y Lenguaje</b></td></tr>
