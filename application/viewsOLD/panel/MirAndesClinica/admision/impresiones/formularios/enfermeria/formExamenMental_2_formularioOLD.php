...
<div class="col-lg-6" align="left">
    <div style=" display: inline-block">
        <table style="border:2px solid grey">
            <tr><td colspan="4" align="left"><b>7. Alteración de la Afectividad</b></td></tr>
    ...
    <div style=" display: inline-block; ">
        ...
        <table style="border:2px solid grey">
            <tr><td colspan="2" align="left" style="border:1px solid grey"><b>8. Motórica y Conducta</b></td></tr>
            <!--  style="width: 100px" -->
