            ...
            <?php echo form_close();?>
                ...
                <table class='table table-bordered table-hover table-striped data-table'>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a class="tip-bottom" title="Cargar Insumos" href="<?php echo base_url("clinica_admision/tecs/cargarInsumos/".$ses->tecSesTecId.'_'.$ses->tecSesId)?>"><i class="fa fa-plus-square" aria-hidden="true"></i></a>&nbsp;&nbsp;
                        </td>
                        <!--
                        <td align="center">
