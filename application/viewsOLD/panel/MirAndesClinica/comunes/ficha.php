    ...
    function cargaModal(rut){
        ...
        $.ajax({
            ...
            //bloque de historial de ingresos(registros)
                ...
                var table = '<table class="table table-bordered table-striped table-hover data-table" style="font-size: 10px; width:100%;" > <thead> <tr> <th>Id</th><th>Fecha de Ingreso</th><th>Fecha de Alta</th><th>Imprimir</th><th>Ver Controles Médicos</th><th>Evaluación de Ingreso</th><th>Ver Evolucion Diaria</th> </tr> </thead>';
