...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
            ...
            <!-- DATOS DE CLINICOS-->  
                    ...
                    <div class="col-lg-4">
                        ...
                        <a href="<?php echo base_url("clinica_enfermeria/ingresos/cargarEscalaSuicidio/".$evo->evoId.'_'.$evo->evoRegistro )?>"><i class="fa fa-plus-circle" aria-hidden="true" style=" cursor: pointer;color: red"></i></a>
                    </div>
                    <div class="col-lg-12"><br></div>
                    <div class="col-lg-2">
                        <label>Talla: </label>
                    ...
                    <div class="col-lg-4">
                        ...
                        <a href="<?php echo base_url("clinica_enfermeria/ingresos/cargarEscalaCaida/".$evo->evoId.'_'.$evo->evoRegistro )?>"><i class="fa fa-plus-circle" aria-hidden="true" style=" cursor: pointer;color: red"></i></a>
                    </div>
