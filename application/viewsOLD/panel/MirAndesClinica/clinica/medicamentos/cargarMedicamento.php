...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
                ...
                <div class="col-lg-12">
                    <table style="border:1px solid grey">
                        <tr>
                            <td colspan="2" align="center" style="border:1px solid grey"><b>Mapa de Caracteres</b></td>
                        </tr>
                        <tr>
                            <td>Dosis completa sin administrar&nbsp;&nbsp;</td>
                            <td style="background-color: grey">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        </tr><tr>
                            <td>Farmaco administrado</td>
                            <td style="background-color: green">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                        <tr>
                            <td>¼ de dosis por administrar</td>
                            <td style="background-color: #85C1E9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                        <tr>
                            <td>½ de dosis por administrar</td>
                            <td style="background-color: #4CA5E0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                        <tr>
                            <td>¾ de dosis por administrar</td>
