...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
            ...
            <!-- DATOS DE CLINICOS-->  
                    ...
                    <div class='col-lg-10'>
                        <input type="text" style="width: 94%;" name="evoDiagPsiquiatra" value="<?php IF(!empty($evo->evoDiagPsiquiatra))echo $evo->evoDiagPsiquiatra;?>">
                    </div>
                    <div class="col-lg-12"><br></div>
                    <div class="col-lg-2">
                    ...
                    <div class='col-lg-10'>
                        <input type="text" style="width: 94%;" name="evoDiagMedico"      value="<?php IF(!empty($evo->evoDiagMedico))echo $evo->evoDiagMedico;?>">
                    </div>
                    <div class="col-lg-12"><br></div>
                    <div class="col-lg-2">
                        <label>Regimen: </label>
                    ...
                    <div class="col-lg-3">Día: <input type="text" name="evoSueDia" value="<?php echo $evo->evoSueDia;?>">
                    </div>
                    <div class="col-lg-3">Noche: <input type="text" name="evoSueNoche" value="<?php echo $evo->evoSueNoche;?>">
                    </div>
                    <div class="col-lg-12"><br></div>
                    <div class="col-lg-2"><label>Hidratación</label>
                    </div>
                    <div class="col-lg-3">Día: <input type="text" name="evoHidraDia" value="<?php echo $evo->evoHidraDia;?>">
                    </div>
                    <div class="col-lg-3">Noche: <input type="text" name="evoHidraNoche" value="<?php echo $evo->evoHidraNoche;?>">
                    </div>
                    <div class="col-lg-12"><br></div>
                    <div class="col-lg-2"><label>Alimentación</label>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="evoTO1" value="<?php echo $TO[0];?>">
                    </div>
                    <div class="col-lg-2"><label>Teléfono</label>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="evoTO2" value="<?php echo $TO[1];?>">
                    </div>
                    <div class="col-lg-2"><label>Salidas</label>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="evoTOOtro" value="<?php echo $TO[2];?>">
                    </div>
                    <div class="col-lg-2"><label>Cuidador</label>
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class='col-lg-12'><br></div>
                    <div class="col-lg-4">
                        <label>PLAN DE ENFERMERIA</label><br><textarea name="evoPlan"><?php echo $evo->evoPlan;?></textarea>
                    </div>
                    <div class="col-lg-4">
                        <label>EXAMENES</label><br><textarea name="evoExamenes"><?php echo $evo->evoExamenes;?></textarea>
                    </div>
                    <div class="col-lg-4">
                        <label>OBSERVAR Y AVISAR</label><br><textarea name="evoAvisar"><?php echo $evo->evoAvisar;?></textarea>
                    </div>
                    <div class='col-lg-12'><br></div>
