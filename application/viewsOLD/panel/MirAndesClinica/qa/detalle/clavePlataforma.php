...
box-shadow: -2px 2px 41px 2px rgba(0,0,0,0.75);z-index: 25; background-color: #db8918">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" style="border-color: #000000;"  >
            ...
            //die(var_dump($datos));
                echo form_open('qa/detalle/guardarPlataforma',$attributes);
            ?>
...
<div id="divFicha"><!--COMIENZO TRATAMIENTO DE FICHA-->
            ...
            <!-- DATOS DE PERSONALES-->     
                    ...
                    <div class='col-lg-3'>
                        <input name="usuario" type="text" required value="<?php IF(!empty($data))echo $data->uspUsuario; ?>">
                    </div>
                    ...
                    <div class='col-lg-3'>
                        <input name="clave" type="password"  id="clave1" required>
                    </div>
                    <div class='col-lg-3'>
